...
[
  ...
  },
  {
    ...
    "pearsmcguinness": [
      ...
      "If things can occur in states of affairs, this possibility must\nbe in them from the beginning. ",
  ...
  },
  {
    "number": "3.1432",
    "german": [
      "Nicht: „Das komplexe Zeichen ‚<var>aRb</var>‘ sagt, dass <var>a</var> in der Beziehung <var>R</var> zu <var>b</var> steht“, sondern: <em class=\"germph\">Dass</em> „<var>a</var>“ in einer gewissen Beziehung zu „<var>b</var>“ steht, sagt, <em class=\"germph\">dass</em> <var>aRb</var>."
    ],
    "ogden": [
      "We must not say, “The complex sign ‘<var>aRb</var>’ says ‘<var>a</var> stands in relation <var>R</var> to <var>b</var>’”; but we must say, “<em>That</em> ‘<var>a</var>’ stands in a certain relation to ‘<var>b</var>’ says <em>that</em> <var>aRb</var>”."
    ],
    "pearsmcguinness": [
      "Instead of, ‘The complex sign “<var>aRb</var>” says that <var>a</var> stands to <var>b</var> in\nthe relation <var>R</var>’, we ought to put, ‘<em>That</em> “<var>a</var>” stands to “<var>b</var>” in a certain\nrelation says <em>that</em> <var>aRb</var>.’"
    ]
  },
  {
    "number": "3.144",
  ...
  },
  {
    "number": "3.203",
    "german": [
      "Der Name bedeutet den Gegenstand. Der Gegenstand ist seine Bedeutung. („<var>A</var>“ ist dasselbe Zeichen wie „<var>A</var>“.)"
    ],
    "ogden": [
      "The name means the object. The object is its meaning. (“<var>A</var>” is the same sign as “<var>A</var>”.)"
    ],
    "pearsmcguinness": [
      "A name means an object. The object is its meaning. (‘<var>A</var>’ is the same sign as ‘<var>A</var>’.)"
    ]
  },
  {
    "number": "3.21",
  ...
  },
  {
    ...
    "pearsmcguinness": [
      "What a proposition expresses it expresses in a determinate manner, which can be set out clearly: a proposition is articulated."
    ]
  },
  {
    "number": "3.26",
  ...
  },
  {
    ...
    "german": [
      ...
      "Nehmen wir nämlich an, die Funktion <var class=\"pushvar\">F</var>(<var>fx</var>) könnte ihr eigenes Argument sein; dann gäbe es also einen Satz: „<var class=\"pushvar\">F</var>(<var class=\"pushvar\">F</var>(<var>fx</var>))“ und in diesem müssen die äußere Funktion <var>F</var> und die innere Funtion <var>F</var> verschiedene Bedeutungen haben, denn die innere hat die Form <var>ϕ</var>(<var>fx</var>), die äußere die Form <var>ψ</var>(<var>ϕ</var>(<var>fx</var>)). Gemeinsam ist den beiden Funktionen nur der Buchstabe „<var>F</var>“, der aber allein nichts bezeichnet.",
      "Dies wird sofort klar, wenn wir statt „<var class=\"pushvar\">F</var>(<var>F</var><var>u</var>)“ schreiben „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>ϕ</var>):</span><var class=\"pushvar\">F</var>(<var>ϕu</var>)<span class=\"mathrel\">.</span><var>ϕu</var><span class=\"mathrel\">=</span><var>Fu</var>“.",
    ...
    "ogden": [
      ...
      "If, for example, we suppose that the function <var class=\"pushvar\">F</var>(<var>fx</var>) could be its own argument, then there would be a proposition “<var class=\"pushvar\">F</var>(<var class=\"pushvar\">F</var>(<var>fx</var>))”, and in this the outer function <var>F</var> and the inner function <var>F</var> must have different meanings; for the inner has the form <var>ϕ</var>(<var>fx</var>), the outer the form <var>ψ</var>(<var>ϕ</var>(<var>fx</var>)). Common to both functions is only the letter “<var>F</var>”, which by itself signifies nothing.",
      "This is at once clear, if instead of “<var class=\"pushvar\">F</var>(<var>F</var><var>u</var>)” we write “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>ϕ</var>):</span><var class=\"pushvar\">F</var>(<var>ϕu</var>)<span class=\"mathrel\">.</span><var>ϕu</var><span class=\"mathrel\">=</span><var>Fu</var>”.",
    ...
    "pearsmcguinness": [
      ...
      "For let us suppose that the function <var class=\"pushvar\">F</var>(<var>fx</var>) could be its own argument: in that case there would be a proposition ‘<var class=\"pushvar\">F</var>(<var class=\"pushvar\">F</var>(<var>fx</var>))’, in which the outer function <var>F</var> and the inner function <var>F</var> must have different meanings, since the inner one has the form <var>ϕ</var>(<var>fx</var>) and the outer one has the form <var>ψ</var>(<var>ϕ</var>(<var>fx</var>)). Only the letter ‘<var>F</var>’ is common to the two functions, but the letter by itself signifies nothing.",
      "This immediately becomes clear if instead of ‘<var class=\"pushvar\">F</var>(<var>F</var><var>u</var>)’ we write ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>ϕ</var>):</span><var class=\"pushvar\">F</var>(<var>ϕu</var>)<span class=\"mathrel\">.</span><var>ϕu</var><span class=\"mathrel\">=</span><var>Fu</var>’.",
  ...
  },
  {
    "number": "3.3441",
    "german": [
      "Man kann z. B. das Gemeinsame aller Notationen für die Wahrheitsfunktionen so ausdrücken: Es ist ihnen gemeinsam, dass sich alle – z. B. – durch die Notation von „<span class=\"mathop\">~</span><var>p</var>“ („nicht <var>p</var>“) und „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>“ („<var>p</var> oder <var>q</var>“) <em class=\"germph\">ersetzen lassen</em>.",
      "(Hiermit ist die Art und Weise gekennzeichnet, wie eine spezielle mögliche Notation uns allgemeine Aufschlüsse geben kann.)"
    ],
    "ogden": [
      "We can, for example, express what is common to all notations for the truth-functions as follows: It is common to them that they all, for example, <em>can be replaced</em> by the notations of “<span class=\"mathop\">~</span><var>p</var>” (“not <var>p</var>”) and “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>” (“<var>p</var> or <var>q</var>”).",
      "(Herewith is indicated the way in which a special possible notation can give us general information.)"
    ],
    "pearsmcguinness": [
      "For instance, we can express what is common to all notations for truth-functions in the following way: they have in common that, for example, the notation that uses ‘<span class=\"mathop\">~</span><var>p</var>’ (‘not <var>p</var>’) and ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>’ (‘<var>p</var> or <var>q</var>’) <em>can be substituted</em> for any of them.",
  ...
  },
  {
    "number": "4.012",
    "german": [
      "Offenbar ist, dass wir einen Satz von der Form „<var>aRb</var>“ als Bild empfinden. Hier ist das Zeichen offenbar ein Gleichnis des Bezeichneten."
    ],
    "ogden": [
      "It is obvious that we perceive a proposition of the form <var>aRb</var> as a picture. Here the sign is obviously a likeness of the signified."
    ],
    "pearsmcguinness": [
      "It is obvious that a proposition of the form ‘<var>aRb</var>’ strikes us as a picture. In this case the sign is obviously a likeness of what is signified."
    ]
  },
  {
    "number": "4.013",
    "german": [
      "Und wenn wir in das Wesentliche dieser Bildhaftigkeit eindringen, so sehen wir, dass dieselbe durch <em class=\"germph\">scheinbare Unregelmäßigkeiten</em> (wie die Verwendung von ♯ und <span class=\"symbol\">♭</span> in der Notenschrift) <em class=\"germph\">nicht</em> gestört wird.",
      "Denn auch diese Unregelmäßigkeiten bilden das ab, was sie ausdrücken sollen; nur auf eine andere Art und Weise."
    ],
    "ogden": [
      "And if we penetrate to the essence of this pictorial nature we see that this is not disturbed by <em>apparent irregularities</em> (like the use of ♯ and <span class=\"symbol\">♭</span>  in the score).",
      "For these irregularities also picture what they are to express; only in another way."
    ],
    "pearsmcguinness": [
      "And if we penetrate to the essence of this pictorial character, we see that it is <em>not</em> impaired by <em>apparent irregularities</em> (such as the use of ♯ and <span class=\"symbol\">♭</span> in musical notation).",
  ...
  },
  {
    ...
    "pearsmcguinness": [
      ...
      "The two must possess the same logical (mathematical) multiplicity. (Compare Hertz’s <i>Mechanics</i> on dynamical models.)"
    ]
  },
  {
    "number": "4.041",
  ...
  },
  {
    "number": "4.0411",
    "german": [
      "Wollten wir z. B. das, was wir durch „<span class=\"quant\">(<var>x</var>).</span><var>fx</var>“ ausdrücken, durch Vorsetzen eines Indexes von „<var>fx</var>“ ausdrücken – etwa so: „<span class=\"mathop\"><span class=\"mathrm\"><var>Alg</var>.</span></span><var>fx</var>“ – es würde nicht genügen – wir wüssten nicht, was verallgemeinert wurde. Wollten wir es durch einen Index „<sub><var>a</var></sub>“ anzeigen – etwa so: „<var class=\"pushvar\">f</var>(<var>x</var><sub><var>a</var></sub>)“ – es würde auch nicht genügen – wir wüssten nicht den Bereich der Allgemeinheitsbezeichnung.",
      "Wollten wir es durch Einführung einer Marke in die Argumentstellen versuchen – etwa so: „<span class=\"mathop\">(<var>A</var>, <var>A</var>).</span><var class=\"pushvar\">F</var>(<var>A</var>, <var>A</var>)“ – es würde nicht genügen – wir könnten die Identität der Variablen nicht feststellen. U.s.w.",
      "Alle diese Bezeichnungsweisen genügen nicht, weil sie nicht die notwendige mathematische Mannigfaltigkeit haben."
    ],
    "ogden": [
      "If we tried, for example, to express what is expressed by “<span class=\"quant\">(<var>x</var>).</span><var>fx</var>” by putting an index before <var>fx</var>, like: “<span class=\"mathop\"><span class=\"mathrm\"><var>Gen</var>.</span></span><var>fx</var>”, it would not do, we should not know what was generalized. If we tried to show it by an index <var>g</var>, like: “<var class=\"pushvar\">f</var>(<var>x</var><sub><var>g</var></sub>)” it would not do—we should not know the scope of the generalization.",
      "If we were to try it by introducing a mark in the argument places, like “<span class=\"mathop\">(<var>G</var>, <var>G</var>).</span><var class=\"pushvar\">F</var>(<var>G</var>, <var>G</var>)”, it would not do—we could not determine the identity of the variables, etc.",
    ...
    "pearsmcguinness": [
      ...
      "If we were to try to do it by introducing a mark into the argument-places—for instance by writing ‘<span class=\"mathop\">(<var>G</var>, <var>G</var>).</span><var class=\"pushvar\">F</var>(<var>G</var>, <var>G</var>)’—it would not be adequate: we should not be able to establish the identity of the variables. And so on.",
  ...
  },
  {
    ...
    "german": [
      ...
      "Man könnte dann z. B. sagen, dass „<var>p</var>“ auch die wahre Art bezeichnet, was „<span class=\"mathop\">~</span><var>p</var>“ auf die falsche Art, etc."
    ],
    "ogden": [
      ...
      "One could, then, for example, say that “<var>p</var>” signifies in the true way what “<span class=\"mathop\">~</span><var>p</var>” signifies in the false way, etc."
    ],
    "pearsmcguinness": [
      ...
      "In that case one could say, for example, that ‘<var>p</var>’ signified in the true way what ‘<span class=\"mathop\">~</span><var>p</var>’ signified in the false way, etc."
    ]
  },
  {
    "number": "4.062",
    "german": [
      "Kann man sich nicht mit falschen Sätzen, wie bisher mit wahren, verständigen? Solange man nur weiß, dass sie falsch gemeint sind. Nein! Denn, wahr ist ein Satz, wenn es sich so verhält, wie wir es durch ihn sagen; und wenn wir mit „<var>p</var>“ <span class=\"mathop\">~</span><var>p</var> meinen, und es sich so verhält wie wir es meinen, so ist „<var>p</var>“ in der neuen Auffassung wahr und nicht falsch."
    ],
    "ogden": [
      "Can we not make ourselves understood by means of false propositions as hitherto with true ones, so long as we know that they are meant to be false? No! For a proposition is true, if what we assert by means of it is the case; and if by “<var>p</var>” we mean <span class=\"mathop\">~</span><var>p</var>, and what we mean is the case, then “<var>p</var>” in the new conception is true and not false."
    ],
    "pearsmcguinness": [
      "Can we not make ourselves understood with false propositions just as we have done up till now with true ones?—So long as it is known that they are meant to be false.—No! For a proposition is true if we use it to say that things stand in a certain way, and they do; and if by ‘<var>p</var>’ we mean <span class=\"mathop\">~</span><var>p</var> and things stand as we mean that they do, then, construed in the new way, ‘<var>p</var>’ is true and not false."
    ]
  },
  {
    "number": "4.0621",
    "german": [
      "Dass aber die Zeichen „<var>p</var>“ und „<span class=\"mathop\">~</span><var>p</var>“ das gleiche sagen <em class=\"germph\">können</em>, ist wichtig. Denn es zeigt, dass dem Zeichen „<span class=\"mathop\">~</span>“ in der Wirklichkeit nichts entspricht.",
      "Dass in einem Satz die Verneinung vorkommt, ist noch kein Merkmal seines Sinnes (<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">=</span><var>p</var>).",
      "Die Sätze „<var>p</var>“ und „<span class=\"mathop\">~</span><var>p</var>“ haben entgegengesetzten Sinn, aber es entspricht ihnen eine und dieselbe Wirklichkeit."
    ],
    "ogden": [
      "That, however, the signs “<var>p</var>” and “<span class=\"mathop\">~</span><var>p</var>” <em>can</em> say the same thing is important, for it shows that the sign “<span class=\"mathop\">~</span>” corresponds to nothing in reality.",
      "That negation occurs in a proposition, is no characteristic of its sense (<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">=</span><var>p</var>).",
      "The propositions “<var>p</var>” and “<span class=\"mathop\">~</span><var>p</var>” have opposite senses, but to them corresponds one and the same reality."
    ],
    "pearsmcguinness": [
      "But it is important that the signs ‘<var>p</var>’ and ‘<span class=\"mathop\">~</span><var>p</var>’ can say the same thing. For it shows that nothing in reality corresponds to the sign ‘<span class=\"mathop\">~</span>’.",
      "The occurrence of negation in a proposition is not enough to characterize its sense (<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">=</span><var>p</var>).",
      "The propositions ‘<var>p</var>’ and ‘<span class=\"mathop\">~</span><var>p</var>’ have opposite sense, but there corresponds to them one and the same reality."
    ]
  },
  {
    "number": "4.063",
    ...
    "ogden": [
      ...
      "But to be able to say that a point is black or white, I must first know under what conditions a point is called white or black; in order to be able to say “<var>p</var>” is true (or false) I must have determined under what conditions I call “<var>p</var>” true, and thereby I determine the sense of the proposition.",
  ...
  },
  {
    "number": "4.116",
    "german": [
      "Alles was überhaupt gedacht werden kann, kann klar gedacht werden. Alles, was sich aussprechen läss"
    ],
    "ogden": [
  ...
  },
  {
    "number": "4.1211",
    "german": [
      "So zeigt ein Satz „<var>fa</var>“, dass in seinem Sinn der Gegenstand <var>a</var> vorkommt, zwei Sätze „<var>fa</var>“ und „<var>ga</var>“, dass in ihnen beiden von demselben Gegenstand die Rede ist.",
      "Wenn zwei Sätze einander widersprechen. So zeigt dies ihre Struktur; ebenso, wenn einer aus dem anderen folgt. U.s.w."
    ],
    "ogden": [
      "Thus a proposition “<var>fa</var>” shows that in its sense the object <var>a</var> occurs, two propositions “<var>fa</var>” and “<var>ga</var>” that they are both about the same object.",
      "If two propositions contradict one another, this is shown by their structure; similarly if one follows from another, etc."
    ],
    "pearsmcguinness": [
      "Thus one proposition ‘<var>fa</var>’ shows that the object <var>a</var> occurs in its sense, two propositions ‘<var>fa</var>’ and ‘<var>ga</var>’ show that the same object is mentioned in both of them.",
  ...
  },
  {
    ...
    "german": [
      ...
      "Ebenso die Reihe der Sätze „<var>aRb</var>“,",
      "„<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>):</span><var>aRx</var><span class=\"mathrel\">.</span><var>xRb</var>“,",
      "„<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>):</span><var>aRx</var><span class=\"mathrel\">.</span><var>xRy</var><span class=\"mathrel\">.</span><var>yRb</var>“, u. s. f.",
      "(Steht <var>b</var> in einer dieser Beziehungen zu <var>a</var>, so nenne ich <var>b</var> einen Nachfolder von <var>a</var>.)"
    ],
    "ogden": [
      ...
      "Similarly the series of propositions “<var>aRb</var>”,",
      "“<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>):</span><var>aRx</var><span class=\"mathrel\">.</span><var>xRb</var>”,",
      "“<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>):</span><var>aRx</var><span class=\"mathrel\">.</span><var>xRy</var><span class=\"mathrel\">.</span><var>yRb</var>”, etc.",
      "(If <var>b</var> stands in one of these relations to <var>a</var>, I call <var>b</var> a successor of <var>a</var>.)"
    ],
    "pearsmcguinness": [
      ...
      "The same is true of the series of propositions ‘<var>aRb</var>’,",
      "‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>):</span><var>aRx</var><span class=\"mathrel\">.</span><var>xRb</var>’,",
      "‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>):</span><var>aRx</var><span class=\"mathrel\">.</span><var>xRy</var><span class=\"mathrel\">.</span><var>yRb</var>’, and so forth.",
      "(If <var>b</var> stands in one of these relations to <var>a</var>, I call <var>b</var> a successor of <var>a</var>.)"
    ]
  },
  {
  ...
  },
  {
    "number": "4.1272",
    "german": [
      "So ist der variable Name „<var>x</var>“ das eigentliche Zeichen des Scheinbegriffes <em class=\"germph\">Gegenstand</em>.",
      ...
      "Zum Beispiel in dem Satz „es gibt 2 Gegenstände, welche …“ durch „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>)</span>…“.",
      "Wo immer es anders, also als eigentliches Begriffswort gebraucht wird, entstehen unsinnige Scheinsätze.",
      "So kann man z. B. nicht sagen „Es gibt Gegenstände“, wie man etwa sagt: „Es gibt Bücher“. Und ebenso wenig: „Es gibt 100 Gegenstände“, oder „Es gibt <span class=\"symbol\">ℵ</span><sub>0</sub> Gegenstände“.",
      ...
      "(Es ist ebenso unsinnig zu sagen: „Es gibt nur Eine 1“, als es unsinnig wäre, zu sagen: „2<span class=\"mathrel\">+</span>2 ist um 3 Uhr gleich 4“.)"
    ],
    "ogden": [
      "So the variable name “<var>x</var>” is the proper sign of the pseudo-concept <em>object</em>.",
      "Wherever the word “object” (“thing”, “entity”, etc.) is rightly used, it is expressed in logical symbolism by the variable name.",
      "For example in the proposition “there are two objects which …”, by “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>)</span>…”.",
      "Wherever it is used otherwise, <em>i.e.</em> as a proper concept word, there arise senseless pseudo-propositions.",
      "So one cannot, <em>e.g.</em> say “There are objects” as one says “There are books”. Nor “There are 100 objects” or “There are <span class=\"symbol\">ℵ</span><sub>0</sub> objects”.",
      ...
      "(It is as senseless to say, “there is only one 1” as it would be to say: 2<span class=\"mathrel\">+</span>2 is at 3 o’clock equal to 4.)"
    ],
    "pearsmcguinness": [
      "Thus the variable name ‘<var>x</var>’ is the proper sign for the pseudo-concept <em>object</em>.",
      "Wherever the word ‘object’ (‘thing’, etc.) is correctly used, it is expressed in conceptual notation by a variable name.",
      "For example, in the proposition, ‘There are 2 objects which …’, it is expressed by ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>)</span>…’.",
      "Wherever it is used in a different way, that is as a proper concept-word, nonsensical pseudo-propositions are the result.",
      "So one cannot say, for example, ‘There are objects’, as one might say, ‘There are books’. And it is just as impossible to say, ‘There are 100 objects’, or, ‘There are <span class=\"symbol\">ℵ</span><sub>0</sub> objects’.",
      ...
      "(It is just as nonsensical to say, ‘There is only one 1’, as it would be to say, ‘2<span class=\"mathrel\">+</span>2 at 3 o’clock equals 4’.)"
    ]
  },
  {
    "number": "4.12721",
  ...
  },
  {
    ...
    "ogden": [
      "If we want to express in logical symbolism the general proposition “<var>b</var> is a successor of <var>a</var>” we need for this an expression for the general term of the formal series: ",
      "<div class=\"centered\"><var>aRb</var>,<br>\n<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>):</span><var>aRx</var><span class=\"mathrel\">.</span><var>xRb</var>,<br>\n<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>):</span><var>aRx</var><span class=\"mathrel\">.</span><var>xRy</var><span class=\"mathrel\">.</span><var>yRb</var>,<br>\n…&nbsp; .</div>",
    ...
    "pearsmcguinness": [
      "If we want to express in conceptual notation the general proposition, ‘<var>b</var> is a successor of <var>a</var>’, then we require an expression for the general term of the series of forms",
      "<div class=\"centered\"><var>aRb</var>,<br>\n<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>):</span><var>aRx</var><span class=\"mathrel\">.</span><var>xRb</var>,<br>\n<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>):</span><var>aRx</var><span class=\"mathrel\">.</span><var>xRy</var><span class=\"mathrel\">.</span><var>yRb</var>,<br>\n…&nbsp; .</div>",
  ...
  },
  {
    "number": "4.24",
    "german": [
      "Die Namen sind die einfachen Symbole, ich deute sie durch einzelne Buchstaben („<var>x</var>“, „<var>y</var>“, „<var>z</var>“) an.",
      "Den Elementarsatz schreibe ich als Funktion der Namen in der Form: „<var>fx</var>“, „<var>ϕ</var>(<var>x</var>,<var>y</var>)“, etc.",
      "Oder ich deute ihn durch die Buchstaben <var>p</var>, <var>q</var>, <var>r</var> an."
    ],
    "ogden": [
      "The names are the simple symbols, I indicate them by single letters (<var>x</var>, <var>y</var>, <var>z</var>).",
      "The elementary proposition I write as function of the names, in the form “<var>fx</var>”, “<var>ϕ</var>(<var>x</var>,<var>y</var>)”, etc.",
      "Or I indicate it by the letters <var>p</var>, <var>q</var>, <var>r</var>."
    ],
    "pearsmcguinness": [
      "Names are the simple symbols: I indicate them by single letters (‘<var>x</var>’, ‘<var>y</var>’, ‘<var>z</var>’).",
      "I write elementary propositions as functions of names, so that they have the form ‘<var>fx</var>’, ‘<var>ϕ</var>(<var>x</var>,<var>y</var>)’, etc.",
      "Or I indicate them by the letters ‘<var>p</var>’, ‘<var>q</var>’, ‘<var>r</var>’."
    ]
  },
  {
    "number": "4.241",
    "german": [
      ...
      "„<var>a</var><span class=\"mathrel\">=</span><var>b</var>“ heißt also: das Zeichen „<var>a</var>“ ist durch das Zeichen „<var>b</var>“ ersetzbar.",
      "(Führe ich durch eine Gleichung ein neues Zeichen „<var>b</var>“ ein, indem ich bestimme, es solle ein bereits bekanntes Zeichen „<var>a</var>“ ersetzen, so schreibe ich die Gleichung – Definition – (wie Russell) in der Form „<var>a</var><span class=\"mathrel\">=</span><var>b</var> Def.“. Die Definition ist eine Zeichenregel.)"
    ],
    "ogden": [
      "If I use two signs with one and the same meaning, I express this by putting between them the sign “=”.",
      "“<var>a</var><span class=\"mathrel\">=</span><var>b</var>” means then, that the sign “<var>a</var>” is replaceable by the sign “<var>b</var>”.",
      "(If I introduce by an equation a new sign “<var>b</var>”, by determining that it shall replace a previously known sign “<var>a</var>”, I write the equation—definition—(like Russell) in the form “<var>a</var><span class=\"mathrel\">=</span><var>b</var> Def.”. A definition is a symbolic rule.)"
    ],
    "pearsmcguinness": [
      "When I use two signs with one and the same meaning, I express this by putting the sign ‘=’ between them.",
      "So ‘<var>a</var><span class=\"mathrel\">=</span><var>b</var>’ means that the sign ‘<var>b</var>’ can be substituted for the sign ‘<var>a</var>’.",
      "(If I use an equation to introduce a new sign ‘<var>b</var>’, laying down that it shall serve as a substitute for a sign ‘<var>a</var>’ that is already known, then, like Russell, I write the equation—definition—in the form ‘<var>a</var><span class=\"mathrel\">=</span><var>b</var> Def.’ A definition is a rule dealing with signs.)"
    ]
  },
  {
    "number": "4.242",
    "german": [
      "Ausdrücke von der Form „<var>a</var><span class=\"mathrel\">=</span><var>b</var>“ sind also nur Behelfe der Darstellung; sie sagen nichts über die Bedeutung der Zeichen „<var>a</var>“, „<var>b</var>“ aus."
    ],
    "ogden": [
      "Expressions of the form “<var>a</var><span class=\"mathrel\">=</span><var>b</var>” are therefore only expedients in presentation: They assert nothing about the meaning of the signs “<var>a</var>” and “<var>b</var>”."
    ],
    "pearsmcguinness": [
      "Expressions of the form ‘<var>a</var><span class=\"mathrel\">=</span><var>b</var>’ are, therefore, mere representational devices. They state nothing about the meaning of the signs ‘<var>a</var>’ and ‘<var>b</var>’."
    ]
  },
  {
    "number": "4.243",
    "german": [
      ...
      "Ausdrücke wie „<var>a</var><span class=\"mathrel\">=</span><var>a</var>“, oder von diesen abgeleitete, sind weder Elementarsätze, noch sonst sinnvolle Zeichen. (Dies wird sich später zeigen.)"
    ],
    "ogden": [
      ...
      "Expressions like “<var>a</var><span class=\"mathrel\">=</span><var>a</var>”, or expressions deduced from these are neither elementary propositions nor otherwise significant signs. (This will be shown later.)"
    ],
    "pearsmcguinness": [
      ...
      "Expressions like ‘<var>a</var><span class=\"mathrel\">=</span><var>a</var>’, and those derived from them, are neither elementary propositions nor is there any other way in which they have sense. (This will become evident later.)"
    ]
  },
  {
    "number": "4.25",
  ...
  },
  {
    "number": "4.27",
    "german": [
      "Bezüglich des Bestehens und Nichtbestehens von <var>n</var> Sachverhalten gibt es <table class=\"possibilities\"><tbody><tr><td rowspan=\"3\" class=\"middleright\">K<sub><var>n</var></sub> = </td><td class=\"summationtop\"><var class=\"smallvar\">n</var></td><td rowspan=\"3\" class=\"middleright\"><span class=\"largeparen\">(</span></td><td rowspan=\"3\" class=\"middlecenter\"><var>n</var><br><var>ν</var></td><td rowspan=\"3\" class=\"middleleft\"><span class=\"largeparen\">)</span></td></tr><tr><td class=\"summationmiddle\"><span class=\"largeop\">∑</span></td></tr><tr><td class=\"summationbottom\"><span class=\"smallvar\"><var>ν</var> = 0</span></td></tr></tbody></table> Möglichkeiten.",
      "Es können alle Kombinationen der Sachverhalte bestehen, die andern nicht bestehen."
    ],
    "ogden": [
      "With regard to the existence of <var>n</var> atomic facts there are <table class=\"possibilities\"><tbody><tr><td rowspan=\"3\" class=\"middleright\">K<sub><var>n</var></sub> = </td><td class=\"summationtop\"><var class=\"smallvar\">n</var></td><td rowspan=\"3\" class=\"middleright\"><span class=\"largeparen\">(</span></td><td rowspan=\"3\" class=\"middlecenter\"><var>n</var><br><var>ν</var></td><td rowspan=\"3\" class=\"middleleft\"><span class=\"largeparen\">)</span></td></tr><tr><td class=\"summationmiddle\"><span class=\"largeop\">∑</span></td></tr><tr><td class=\"summationbottom\"><span class=\"smallvar\"><var>ν</var> = 0</span></td></tr></tbody></table>  possibilities.",
      "It is possible for all combinations of atomic facts to exist, and the others not to exist."
    ],
    "pearsmcguinness": [
      "For <var>n</var> states of affairs, there are <table class=\"possibilities\"><tbody><tr><td rowspan=\"3\" class=\"middleright\">K<sub><var>n</var></sub> = </td><td class=\"summationtop\"><var class=\"smallvar\">n</var></td><td rowspan=\"3\" class=\"middleright\"><span class=\"largeparen\">(</span></td><td rowspan=\"3\" class=\"middlecenter\"><var>n</var><br><var>ν</var></td><td rowspan=\"3\" class=\"middleleft\"><span class=\"largeparen\">)</span></td></tr><tr><td class=\"summationmiddle\"><span class=\"largeop\">∑</span></td></tr><tr><td class=\"summationbottom\"><span class=\"smallvar\"><var>ν</var> = 0</span></td></tr></tbody></table> possibilities of existence and non-existence.",
  ...
  },
  {
    "number": "4.28",
    "german": [
      "Diesen Kombinationen entsprechen ebenso viele Möglichkeiten der Wahrheit – und Falschheit – von <var>n</var> Elementarsätzen."
    ],
    "ogden": [
      "To these combinations correspond the same number of possibilities of the truth—and falsehood—of <var>n</var> elementary propositions."
    ],
    "pearsmcguinness": [
      "There correspond to these combinations the same number of possibilities of truth—and falsity—for <var>n</var> elementary propositions."
    ]
  },
  {
    "number": "4.3",
  ...
  },
  {
    ...
    "german": [
      ...
      "(Frege hat sie daher ganz richtig als Erklärung der Zeichen seiner Begriffsschrift vorausgeschickt. Nur ist die Erklärung des Wahrheitsbegriffes bei Frege falsch: Wären „das Wahre“ und „das Falsche“ wirklich Gegenstände und die Argumente in <span class=\"mathop\">~</span><var>p</var> etc. dann wäre nach Freges Bestimmung der Sinn von „<span class=\"mathop\">~</span><var>p</var>“ keineswegs bestimmt.)"
    ],
    "ogden": [
      ...
      "(Frege has therefore quite rightly put them at the beginning, as explaining the signs of his logical symbolism. Only Frege’s explanation of the truth-concept is false: if “the true” and “the false” were real objects and the arguments in <span class=\"mathop\">~</span><var>p</var>, etc., then the sense of <span class=\"mathop\">~</span><var>p</var> would by no means be determined by Frege’s determination.)"
    ],
    "pearsmcguinness": [
      ...
      "(Thus Frege was quite right to use them as a starting point when he explained the signs of his conceptual notation. But the explanation of the concept of truth that Frege gives is mistaken: if ‘the true’ and ‘the false’ were really objects, and were the arguments in <span class=\"mathop\">~</span><var>p</var> etc., then Frege’s method of determining the sense of ‘<span class=\"mathop\">~</span><var>p</var>’ would leave it absolutely undetermined.)"
    ]
  },
  {
    "number": "4.44",
  ...
  },
  {
    ...
    "german": [
      "Es ist z. B.:",
      "<div class=\"centered\"><table class=\"truthtable\"><tbody><tr><th></th><th class=\"l\"><var>p</var></th><th class=\"m\"><var>q</var></th><th class=\"e\"></th><th>“</th></tr><tr><td></td><td class=\"l\">W</td><td class=\"m\">W</td><td class=\"e\">W</td><td></td></tr><tr><td></td><td class=\"l\">F</td><td class=\"m\">W</td><td class=\"e\">W</td><td></td></tr><tr><td></td><td class=\"l\">W</td><td class=\"m\">F</td><td class=\"e\"></td><td></td></tr><tr><td>„</td><td class=\"l\">F</td><td class=\"m\">F</td><td class=\"e\">W</td><td></td></tr></tbody></table></div>\n<div class=\"flushright\"> ein Satzzeichen.\n</div>",
      "(Frege’s „Urteilsstrich“ „<span class=\"symbol\">⊢</span>“ ist logisch ganz bedeutunglos; er zeigt bei Frege (und Russell) nur an, dass diese Autoren die so bezeichneten Sätze für wahr halten. \n„<span class=\"symbol\">⊢</span>“ gehört daher ebenso wenig zum Satzgefüge, wie etwa die Nummer des Satzes. Ein Satz kann unmöglich von sich selbst aussagen, dass er wahr ist.)",
      ...
      "<div class=\"displaymath\">„<span class=\"mathop\">(<span class=\"mathrm\">WW–W</span>)</span>&nbsp; (<var>p</var>, <var>q</var>)“</div> oder deutlicher <div class=\"displaymath\">„<span class=\"mathop\">(<span class=\"mathrm\">WWFW</span>)</span>&nbsp; (<var>p</var>, <var>q</var>)“.</div>",
      "(Die Anzahl der Stellen in der linken Klammer ist durch die Anzahl der Glieder in der rechten bestimmt.)"
    ],
    "ogden": [
      "Thus <em>e.g.</em>",
      "<div class=\"centered\"><table class=\"truthtable\"><tbody><tr><th>“</th><th class=\"l\"><var>p</var></th><th class=\"m\"><var>q</var></th><th class=\"e\"></th><th></th></tr><tr><td></td><td class=\"l\">T</td><td class=\"m\">T</td><td class=\"e\">T</td><td></td></tr><tr><td></td><td class=\"l\">F</td><td class=\"m\">T</td><td class=\"e\">T</td><td></td></tr><tr><td></td><td class=\"l\">T</td><td class=\"m\">F</td><td class=\"e\"></td><td></td></tr><tr><td></td><td class=\"l\">F</td><td class=\"m\">F</td><td class=\"e\">T</td><td>”</td></tr></tbody></table></div>\n<div class=\"flushright\"> is a propositional sign.\n</div>",
      "(Frege’s assertion sign “<span class=\"symbol\">⊢</span>” is logically altogether meaningless; in Frege (and Russell) it only shows that these authors hold as true the propositions marked in this way. “<span class=\"symbol\">⊢</span>” belongs therefore to the propositions no more than does the number of the proposition. A proposition cannot possibly assert of itself that it is true.)",
      ...
      "<div class=\"displaymath\">“<span class=\"mathop\">(<span class=\"mathrm\">TT–T</span>)</span>&nbsp; (<var>p</var>, <var>q</var>)”,</div> or more plainly: <div class=\"displaymath\">“<span class=\"mathop\">(<span class=\"mathrm\">TTFT</span>)</span>&nbsp; (<var>p</var>, <var>q</var>)”.</div>",
    ...
    "pearsmcguinness": [
      ...
      "<div class=\"displaymath\">“<span class=\"mathop\">(<span class=\"mathrm\">TT–T</span>)</span>&nbsp; (<var>p</var>, <var>q</var>)”,</div> or more explicitly <div class=\"displaymath\">“<span class=\"mathop\">(<span class=\"mathrm\">TTFT</span>)</span>&nbsp; (<var>p</var>, <var>q</var>)”.</div>",
  ...
  },
  {
    "number": "4.45",
    "german": [
      "Für <var>n</var> Elementarsätze gibt es <span class=\"mathrm\"><var>L</var></span><sub><var>n</var></sub> mögliche Gruppen von Wahrheitsbedingungen.",
    ...
    "ogden": [
      "For <var>n</var> elementary propositions there are <span class=\"mathrm\"><var>L</var></span><sub><var>n</var></sub> possible groups of truth-conditions.",
  ...
  },
  {
    ...
    "german": [
      ...
      "In Russells „+<sub><var>c</var></sub>“ ist z.B. „<sub><var>c</var></sub>“ ein Index, der darauf hinweist, dass das ganze Zeichen das Additionszeichen für Kardinalzahlen ist. Aber diese Bezeichnung beruht auf willkürlicher Übereinkunft und man könnte statt „+<sub><var>c</var></sub>“ auch ein einfaches Zeichen wählen; in „<span class=\"mathop\">~</span><var>p</var>“ aber ist „<var>p</var>“ kein Index, sondern ein Argument: der Sinn von „<span class=\"mathop\">~</span><var>p</var>“ <em class=\"germph\">kann nicht</em> verstanden werden, ohne dass vorher der Sinn von „<var>p</var>“ verstanden worden wäre. (Im Namen Julius Cäsar ist „Julius“ ein Index. Der Index ist immer ein Teil einer Beschreibung des Gegenstandes, dessen Namen wir ihn anhängen. Z. B. <em class=\"germph\">der</em> Cäsar aus dem Geschlechte der Julier.)",
  ...
  },
  {
    ...
    "german": [
      ...
      "<table class=\"fnlist\"><tbody><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">Tautologie&nbsp;</td><td valign=\"top\">(Wenn <var>p</var>, so <var>p</var>; und wenn <var>q</var>, so <var>q</var>.)<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var><span class=\"mathrel\">.</span><var>q</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">in&nbsp;Worten:&nbsp;</td><td valign=\"top\">Nicht beides <var>p</var> und <var>q</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<span class=\"mathop\">~</span>(<var>p</var><span class=\"mathrel\">.</span><var>q</var>))</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">Wenn <var>q</var>, so <var>p</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>q</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">Wenn <var>p</var>, so <var>q</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>p</var> oder <var>q</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">Nicht <var>q</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<span class=\"mathop\">~</span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">Nicht <var>p</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<span class=\"mathop\">~</span><var>p</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>p</var>, oder <var>q</var>, aber nicht beide. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var><span class=\"mathrel\">:<span class=\"symbol\">∨</span>:</span><var>q</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">Wenn <var>p</var>, so <var>q</var>; und wenn <var>q</var>, so <var>p</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\"><span class=\"symbol\">≡</span></span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>p</var></td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>q</var></td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">Weder <var>p</var> noch <var>q</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var>) oder (<var>p</var><span class=\"mathrel\">|</span><var>q</var>)</td></tr> <tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>p</var> und nicht <var>q</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>q</var> und nicht <var>p</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>q</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">W</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>q</var> und <var>p</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>q</var><span class=\"mathrel\">.</span><var>p</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\" colspan=\"2\">Kontradiktion (<var>p</var> und nicht <var>p</var>; und <var>q</var> und nicht <var>q</var>.) <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><var>q</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var>)</td></tr></tbody></table>",
    ...
    "ogden": [
      ...
      "<table class=\"fnlist\"><tbody><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">Tautology&nbsp;</td><td valign=\"top\">(if <var>p</var> then <var>p</var>; and if <var>q</var> then <var>q</var>)<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var><span class=\"mathrel\">.</span><var>q</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var>]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">in&nbsp;words:&nbsp;</td><td valign=\"top\">Not both <var>p</var> and <var>q</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<span class=\"mathop\">~</span>(<var>p</var><span class=\"mathrel\">.</span><var>q</var>)]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">If <var>q</var> then <var>p</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<var>q</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var>]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">If <var>p</var> then <var>q</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var>]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>p</var> or <var>q</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">Not <var>q</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<span class=\"mathop\">~</span><var>q</var>]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">Not <var>p</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<span class=\"mathop\">~</span><var>p</var>]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>p</var> or <var>q</var>, but not both. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var><span class=\"mathrel\">:<span class=\"symbol\">∨</span>:</span><var>q</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">If <var>p</var>, then <var>q</var>; and if <var>q</var>, then <var>p</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<var>p</var><span class=\"mathrel\"><span class=\"symbol\">≡</span></span><var>q</var>]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>p</var></td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>q</var></td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\">Neither <var>p</var> nor <var>q</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var> or <var>p</var><span class=\"mathrel\">|</span><var>q</var>]</td></tr> <tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>p</var> and not <var>q</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var>]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>q</var> and not <var>p</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<var>q</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”</td><td valign=\"top\"><var>p</var> and <var>q</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<var>p</var><span class=\"mathrel\">.</span><var>q</var>]</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\" colspan=\"2\">Contradiction (<var>p</var> and not <var>p</var>; and <var>q</var> and not <var>q</var>.) <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>[<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><var>q</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var>]</td></tr></tbody></table>",
    ...
    "pearsmcguinness": [
      ...
      "<table class=\"fnlist\"><tbody><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">Tautology&nbsp;</td><td valign=\"top\">(If <var>p</var> then <var>p</var>; and if <var>q</var> then <var>q</var>.)<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var><span class=\"mathrel\">.</span><var>q</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">In&nbsp;words:&nbsp;</td><td valign=\"top\">Not both <var>p</var> and <var>q</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<span class=\"mathop\">~</span>(<var>p</var><span class=\"mathrel\">.</span><var>q</var>))</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\">If <var>q</var> then <var>p</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>q</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\">If <var>p</var> then <var>q</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\"><var>p</var> or <var>q</var>.<span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\">Not <var>q</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<span class=\"mathop\">~</span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\">Not <var>p</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<span class=\"mathop\">~</span><var>p</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\"><var>p</var> or <var>q</var>, but not both. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var><span class=\"mathrel\">:<span class=\"symbol\">∨</span>:</span><var>q</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\">If <var>p</var> then <var>q</var>, and if <var>q</var> then <var>p</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\"><span class=\"symbol\">≡</span></span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\"><var>p</var></td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\"><var>q</var></td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\">Neither <var>p</var> nor <var>q</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var> or <var>p</var><span class=\"mathrel\">|</span><var>q</var>)</td></tr> <tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\"><var>p</var> and not <var>q</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\"><var>q</var> and not <var>p</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>q</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">T</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\">&nbsp;”&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;”&nbsp;&nbsp;&nbsp;:</td><td valign=\"top\"><var>q</var> and <var>p</var>. <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>q</var><span class=\"mathrel\">.</span><var>p</var>)</td> </tr><tr><td class=\"righttight\" valign=\"top\">(</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"centertight\" valign=\"top\">F</td><td class=\"lefttight\" valign=\"top\">)</td><td class=\"leftcell\" valign=\"top\">(<var>p</var>,&nbsp;<var>q</var>)&nbsp;&nbsp;</td><td class=\"leftcell\" valign=\"top\" colspan=\"2\">Contradiction (<var>p</var> and not <var>p</var>, and <var>q</var> and not <var>q</var>.) <span class=\"mathrel\"> </span><span class=\"mathrel\"> </span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><var>q</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var>)</td></tr></tbody></table>",
  ...
  },
  {
    "number": "5.12",
    "german": [
      "Insbesondere folgt die Wahrheit eines Satzes „<var>p</var>“ aus der Wahrheit eines anderen „<var>q</var>“, wenn alle Wahrheitsgründe des zweiten Wahrheitsgründe des ersten sind."
    ],
    "ogden": [
      "In particular the truth of a proposition <var>p</var> follows from that of a proposition <var>q</var>, if all the truth-grounds of the second are truth-grounds of the first."
    ],
    "pearsmcguinness": [
      "In particular, the truth of a proposition ‘<var>p</var>’ follows from the truth of another proposition ‘<var>q</var>’ if all the truth-grounds of the latter are truth-grounds of the former."
    ]
  },
  {
    "number": "5.121",
    "german": [
      "Die Wahrheitsgründe des einen sind in denen des anderen enthalten; <var>p</var> folgt aus <var>q</var>."
    ],
    "ogden": [
      "The truth-grounds of <var>q</var> are contained in those of <var>p</var>; <var>p</var> follows from <var>q</var>."
    ],
    "pearsmcguinness": [
      "The truth-grounds of the one are contained in those of the other: <var>p</var> follows from <var>q</var>."
    ]
  },
  {
    "number": "5.122",
    "german": [
      "Folgt <var>p</var> aus <var>q</var>, so ist der Sinn von „<var>p</var>“ im Sinne von „<var>q</var>“ enthalten."
    ],
    "ogden": [
      "If <var>p</var> follows from <var>q</var>, the sense of “<var>p</var>” is contained in that of “<var>q</var>”."
    ],
    "pearsmcguinness": [
      "If <var>p</var> follows from <var>q</var>, the sense of ‘<var>p</var>’ is contained in the sense of ‘<var>q</var>’."
    ]
  },
  {
    "number": "5.123",
    "german": [
      "Wenn ein Gott eine Welt erschafft, worin gewisse Sätze wahr sind, so schafft er damit auch schon eine Welt, in welcher alle ihre Folgesätze stimmen. Und ähnlich könnte er keine Welt schaffen, worin der Satz „<var>p</var>“ wahr ist, ohne seine sämtlichen Gegenstände zu schaffen."
    ],
    "ogden": [
      "If a god creates a world in which certain propositions are true, he creates thereby also a world in which all propositions consequent on them are true. And similarly he could not create a world in which the proposition “<var>p</var>” is true without creating all its objects."
    ],
    "pearsmcguinness": [
      "If a god creates a world in which certain propositions are true, then by that very act he also creates a world in which all the propositions that follow from them come true. And similarly he could not create a world in which the proposition ‘<var>p</var>’ was true without creating all its objects."
    ]
  },
  {
    "number": "5.124",
  ...
  },
  {
    "number": "5.1241",
    "german": [
      "„<var>p</var><span class=\"mathrel\">.</span><var>q</var>“ ist einer der Sätze, welche „<var>p</var>“ bejahen, und zugleich einer der Sätze, welche „<var>q</var>“ bejahen.",
    ...
    "ogden": [
      "“<var>p</var><span class=\"mathrel\">.</span><var>q</var>” is one of the propositions which assert “<var>p</var>” and at the same time one of the propositions which assert “<var>q</var>”.",
    ...
    "pearsmcguinness": [
      "‘<var>p</var><span class=\"mathrel\">.</span><var>q</var>’ is one of the propositions that affirm ‘<var>p</var>’ and at the same time one of the propositions that affirm ‘<var>q</var>’.",
  ...
  },
  {
    "number": "5.1311",
    "german": [
      "Wenn wir von <var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var> und <span class=\"mathop\">~</span><var>p</var> auf <var>q</var> schließen, so ist hier durch die Bezeichnungsweise die Beziehung der Satzformen von „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>“ und „<span class=\"mathop\">~</span><var>p</var>“ verhüllt. Schreiben wir aber z. B. statt „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>“ „<var>p</var><span class=\"mathrel\">|</span><var>q</var><span class=\"mathrel\">.|.</span><var>p</var><span class=\"mathrel\">|</span><var>q</var>“ und statt „<span class=\"mathop\">~</span><var>p</var>“ „<var>p</var><span class=\"mathrel\">|</span><var>p</var>“ (<var>p</var><span class=\"mathrel\">|</span><var>q</var><span class=\"mathrel\">=</span>weder <var>p</var>, noch <var>q</var>), so wird der innere Zusammenhang offenbar.",
      "(Dass man aus <span class=\"quant\">(<var>x</var>).</span><var>fx</var> auf <var>fa</var> schließen kann, das zeigt, dass die Allgemeinheit auch im Symbol „<span class=\"quant\">(<var>x</var>).</span><var>fx</var>“ vorhanden ist.)"
    ],
    "ogden": [
      "When we conclude from <var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var> and <span class=\"mathop\">~</span><var>p</var> to <var>q</var> the relation between the forms of the propositions “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>” and “<span class=\"mathop\">~</span><var>p</var>” is here concealed by the method of symbolizing. But if we write, <em>e.g.</em> instead of “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>” “<var>p</var><span class=\"mathrel\">|</span><var>q</var><span class=\"mathrel\">.|.</span><var>p</var><span class=\"mathrel\">|</span><var>q</var>” and instead of “<span class=\"mathop\">~</span><var>p</var>” “<var>p</var><span class=\"mathrel\">|</span><var>p</var>” (<var>p</var><span class=\"mathrel\">|</span><var>q</var><span class=\"mathrel\">=</span>neither <var>p</var> nor <var>q</var>), then the inner connexion becomes obvious.",
      "(The fact that we can infer <var>fa</var> from <span class=\"quant\">(<var>x</var>).</span><var>fx</var> shows that generality is present also in the symbol “<span class=\"quant\">(<var>x</var>).</span><var>fx</var>”."
    ],
    "pearsmcguinness": [
      "When we infer <var>q</var> from <var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var> and <span class=\"mathop\">~</span><var>p</var>, the relation between the propositional forms of ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>’ and ‘<span class=\"mathop\">~</span><var>p</var>’ is masked, in this case, by our mode of signifying. But if instead of ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>’ we write, for example, ‘<var>p</var><span class=\"mathrel\">|</span><var>q</var><span class=\"mathrel\">.|.</span><var>p</var><span class=\"mathrel\">|</span><var>q</var>’, and instead of ‘<span class=\"mathop\">~</span><var>p</var>’, ‘<var>p</var><span class=\"mathrel\">|</span><var>p</var>’ (<var>p</var><span class=\"mathrel\">|</span><var>q</var><span class=\"mathrel\">=</span>neither <var>p</var> nor <var>q</var>), then the inner connexion becomes obvious.",
      "(The possibility of inference from <span class=\"quant\">(<var>x</var>).</span><var>fx</var> to <var>fa</var> shows that the symbol <span class=\"quant\">(<var>x</var>).</span><var>fx</var> itself has generality in it.)"
    ]
  },
  {
    "number": "5.132",
    "german": [
      "Folgt <var>p</var> aus <var>q</var>, so kann ich von <var>q</var> auf <var>p</var> schließen; <var>p</var> aus <var>q</var> folgern.",
    ...
    "ogden": [
      "If <var>p</var> follows from <var>q</var>, I can conclude from <var>q</var> to <var>p</var>; infer <var>p</var> from <var>q</var>.",
    ...
    "pearsmcguinness": [
      "If <var>p</var> follows from <var>q</var>, I can make an inference from <var>q</var> to <var>p</var>, deduce <var>p</var> from <var>q</var>.",
  ...
  },
  {
    ...
    "pearsmcguinness": [
      ...
      "Belief in the causal nexus is <em>superstition</em>."
    ]
  },
  {
    "number": "5.1362",
    "german": [
      ...
      "(„A weiß, dass <var>p</var> der Fall ist“ ist sinnlos, wenn <var>p</var> eine Tautologie ist.)"
    ],
    "ogden": [
      ...
      "(“A knows that <var>p</var> is the case” is senseless if <var>p</var> is a tautology.)"
    ],
    "pearsmcguinness": [
      ...
      "(‘A knows that <var>p</var> is the case’, has no sense if <var>p</var> is a tautology.)"
    ]
  },
  {
    "number": "5.1363",
  ...
  },
  {
    "number": "5.141",
    "german": [
      "Folgt <var>p</var> aus <var>q</var> und <var>q</var> aus <var>p</var>, so sind sie ein und derselbe Satz."
    ],
    "ogden": [
      "If <var>p</var> follows from <var>q</var> and <var>q</var> from <var>p</var> then they are one and the same proposition."
    ],
    "pearsmcguinness": [
      "If <var>p</var> follows from <var>q</var> and <var>q</var> from <var>p</var>, then they are one and the same proposition."
    ]
  ...
  },
  {
    "number": "5.15",
    "german": [
      "Ist <span class=\"mathrm\">W</span><sub><var>r</var></sub> die Anzahl der Wahrheitsgründe des Satzes „<var>r</var>“, <span class=\"mathrm\">W</span><sub><var>rs</var></sub> die Anzahl derjenigen Wahrheitsgründe des Satzes „<var>s</var>“, die zugleich Wahrheitsgründe von „<var>r</var>“ sind, dann nennen wir das Verhältnis: <span class=\"mathrm\">W</span><sub><var>rs</var></sub> : <span class=\"mathrm\">W</span><sub><var>r</var></sub> das Maß der <em class=\"germph\">Wahrscheinlichkeit</em>, welche der Satz „<var>r</var>“ dem Satz „<var>s</var>“ gibt."
    ],
    "ogden": [
      "If <span class=\"mathrm\">T</span><sub><var>r</var></sub> is the number of the truth-grounds of the proposition “<var>r</var>”, <span class=\"mathrm\">T</span><sub><var>rs</var></sub> the number of those truth-grounds of the proposition “<var>s</var>” which are at the same time truth-grounds of “<var>r</var>”, then we call the ratio <span class=\"mathrm\">T</span><sub><var>rs</var></sub> : <span class=\"mathrm\">T</span><sub><var>r</var></sub> the measure of the <em>probability</em> which the proposition “<var>r</var>” gives to the proposition “<var>s</var>”."
    ],
    "pearsmcguinness": [
      "If <span class=\"mathrm\">T</span><sub><var>r</var></sub> is the number of the truth-grounds of a proposition ‘<var>r</var>’, and if <span class=\"mathrm\">T</span><sub><var>rs</var></sub> is the number of the truth-grounds of a proposition ‘<var>s</var>’ that are at the same time truth-grounds of ‘<var>r</var>’, then we call the ratio <span class=\"mathrm\">T</span><sub><var>rs</var></sub> : <span class=\"mathrm\">T</span><sub><var>r</var></sub> the degree of probability that the proposition ‘<var>r</var>’ gives to the proposition ‘<var>s</var>’."
    ]
  },
  {
    "number": "5.151",
    "german": [
      "Sei in einem Schema wie dem obigen in No. 5.101 <span class=\"mathrm\">W</span><sub><var>r</var></sub> die Anzahl der „W“ im Satze <var>r</var>; <span class=\"mathrm\">W</span><sub><var>rs</var></sub> die Anzahl derjenigen „W“ im Satze <var>s</var>, die in gleichen Kolonnen mit „W“ des Satzes <var>r</var> stehen. Der Satz <var>r</var> gibt dann dem Satze <var>s</var> die Wahrscheinlichkeit: <span class=\"mathrm\">W</span><sub><var>rs</var></sub> : <span class=\"mathrm\">W</span><sub><var>r</var></sub>."
    ],
    "ogden": [
      "Suppose in a schema like that above in No. 5.101 <span class=\"mathrm\">T</span><sub><var>r</var></sub> is the number of the “T”’s in the proposition <var>r</var>, <span class=\"mathrm\">T</span><sub><var>rs</var></sub> the number of those “T”’s in the proposition <var>s</var>, which stand in the same columns as “T”’s of the proposition <var>r</var>; then the proposition <var>r</var> gives to the proposition <var>s</var> the probability <span class=\"mathrm\">T</span><sub><var>rs</var></sub> : <span class=\"mathrm\">T</span><sub><var>r</var></sub>."
    ],
    "pearsmcguinness": [
      "In a schema like the one above in 5.101, let <span class=\"mathrm\">T</span><sub><var>r</var></sub> be the number of ‘T’s’ in the proposition <var>r</var>, and let <span class=\"mathrm\">T</span><sub><var>rs</var></sub>, be the number of ‘T’s’ in the proposition <var>s</var> that stand in columns in which the proposition <var>r</var> has ‘T’s’. Then the proposition <var>r</var> gives to the proposition <var>s</var> the probability <span class=\"mathrm\">T</span><sub><var>rs</var></sub> : <span class=\"mathrm\">T</span><sub><var>r</var></sub>."
    ]
  },
  {
    "number": "5.1511",
  ...
  },
  {
    ...
    "german": [
      ...
      "Folgt <var>p</var> aus <var>q</var>, so gibt der Satz „<var>q</var>“ dem Satz „<var>p</var>“ die Wahrscheinlichkeit 1. Die Gewissheit des logischen Schlusses ist ein Grenzfall der Wahrscheinlichkeit.",
    ...
    "ogden": [
      ...
      "Independent propositions (<em>e.g.</em> any two elementary propositions) give to one another the probability ½.",
      "If <var>p</var> follows from <var>q</var>, the proposition <var>q</var> gives to the proposition <var>p</var> the probability 1. The certainty of logical conclusion is a limiting case of probability.",
    ...
    "pearsmcguinness": [
      ...
      "If <var>p</var> follows from <var>q</var>, then the proposition ‘<var>q</var>’ gives to the proposition ‘<var>p</var>’ the probability 1. The certainty of logical inference is a limiting case of probability.",
  ...
  },
  {
    "number": "5.2341",
    "german": [
      "Der Sinn einer Wahrheitsfunktion von <var>p</var> ist eine Funktion des Sinnes von <var>p</var>.",
      "Verneinung, logische Addition, logische Multiplikation, etc., etc. sind Operationen.",
      "(Die Verneinung verkehrt den Sinn des Satzes.)"
    ],
    "ogden": [
      "The sense of a truth-function of <var>p</var> is a function of the sense of <var>p</var>.",
  ...
  },
  {
    "number": "5.242",
    "german": [
      "Dieselbe Operation, die „<var>q</var>“ aus „<var>p</var>“ macht, macht aus „<var>q</var>“ „<var>r</var>“ u. s. f. Dies kann nur darin ausgedrückt sein, dass „<var>p</var>“, „<var>q</var>“, „<var>r</var>“, etc. Variable sind, die gewisse formale Relationen allgemein zum Ausdruck bringen."
    ],
    "ogden": [
      "The same operation which makes “<var>q</var>” from “<var>p</var>”, makes “<var>r</var>” from “<var>q</var>”, and so on. This can only be expressed by the fact that “<var>p</var>”, “<var>q</var>”, “<var>r</var>”, etc., are variables which give general expression to certain formal relations."
    ],
    "pearsmcguinness": [
      "The operation that produces ‘<var>q</var>’ from ‘<var>p</var>’ also produces ‘<var>r</var>’ from ‘<var>q</var>’, and so on. There is only one way of expressing this: ‘<var>p</var>’, ‘<var>q</var>’, ‘<var>r</var>’, etc. have to be variables that give expression in a general way to certain formal relations."
    ]
  },
  {
    "number": "5.25",
  ...
  },
  {
    "number": "5.2521",
    "german": [
      "Die fortgesetzte Anwendung einer Operation auf ihr eigenes Resultat nenne ich ihre successive Anwendung („<span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>a</var>“ ist das Resultat der dreimaligen successiven Anwendung von „<span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var class=\"pushvar\">ξ</var>“ auf „<var>a</var>“).",
    ...
    "ogden": [
      "The repeated application of an operation to its own result I call its successive application (“<span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>a</var>” is the result of the threefold successive application of “<span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var class=\"pushvar\">ξ</var>” to “<var>a</var>”).",
      "In a similar sense I speak of the successive application of <em>several</em> operations to a number of propositions."
    ],
    "pearsmcguinness": [
      "If an operation is applied repeatedly to its own results, I speak of successive applications of it. (‘<span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>a</var>’ is the result of three successive applications of the operation ‘<span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var class=\"pushvar\">ξ</var>’ to ‘<var>a</var>’.)",
  ...
  },
  {
    "number": "5.2522",
    "german": [
      "Das allgemeine Glied einer Formenreihe <var>a</var>,  <span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>a</var>,  <span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>a</var>,<span class=\"mathrel\">…</span> schreibe ich daher so: „[<var>a</var>,  <var>x</var>,  <span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>x</var>]“. Dieser Klammerausdruck ist eine Variable. Das erste Glied des Klammerausdruckes ist der Anfang der Formenreihe, das zweite die Form eines beliebigen Gliedes <var>x</var> der Reihe und das dritte die Form desjenigen Gliedes der Reihe, welches auf <var>x</var> unmittelbar folgt."
    ],
    "ogden": [
      "The general term of the formal series <var>a</var>,  <span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>a</var>,  <span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>a</var>,<span class=\"mathrel\">…</span>. I write thus: “[<var>a</var>,  <var>x</var>,  <span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>x</var>]”. This expression in brackets is a variable. The first term of the expression is the beginning of the formal series, the second the form of an arbitrary term <var>x</var> of the series, and the third the form of that term of the series which immediately follows <var>x</var>."
    ],
    "pearsmcguinness": [
      "Accordingly I use the sign ‘[<var>a</var>,  <var>x</var>,  <span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>x</var>]’ for the general term of the series of forms <var>a</var>,  <span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>a</var>,  <span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><span class=\"mathop\"><span class=\"mathrm\"><var>O</var>’</span></span><var>a</var>,<span class=\"mathrel\">…</span>. This bracketed expression is a variable: the first term of the bracketed expression is the beginning of the series of forms, the second is the form of a term <var>x</var> arbitrarily selected from the series, and the third is the form of the term that immediately follows <var>x</var> in the series."
    ]
  },
  {
    "number": "5.2523",
  ...
  },
  {
    "number": "5.254",
    "german": [
      "Die Operation kann verschwinden (z. B. die Verneinung in „<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>“: <span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">=</span><var>p</var>)."
    ],
    "ogden": [
      "Operations can vanish (<em>e.g.</em> denial in “<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>”. <span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">=</span><var>p</var>)."
    ],
    "pearsmcguinness": [
      "An operation can vanish (e.g. negation in ‘<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>’: <span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">=</span><var>p</var>)."
    ]
  },
  {
    "number": "5.3",
  ...
  },
  {
    "number": "5.31",
    "german": [
      "Die Schemata No. 4.31 haben auch dann eine Bedeutung, wenn „<var>p</var>“, „<var>q</var>“, „<var>r</var>“, etc. nicht Elementarsätze sind.",
      "Und es ist leicht zu sehen, dass das Satzzeichen in No. 4.442, auch wenn „<var>p</var>“ und „<var>q</var>“ Wahrheitsfunktionen von Elementarsätzen sind, Eine Wahrheitsfunktion von Elementarsätzen ausdrückt."
    ],
    "ogden": [
      "The Schemata No. 4.31 are also significant, if “<var>p</var>”, “<var>q</var>”, “<var>r</var>”, etc. are not elementary propositions.",
      "And it is easy to see that the propositional sign in No. 4.442 expresses one truth-function of elementary propositions even when “<var>p</var>” and “<var>q</var>” are truth-functions of elementary propositions."
    ],
    "pearsmcguinness": [
      "The schemata in 4.31 have a meaning even when ‘<var>p</var>’, ‘<var>q</var>’, ‘<var>r</var>’, etc. are not elementary propositions.",
      "And it is easy to see that the propositional sign in 4.442 expresses a single truth-function of elementary propositions even when ‘<var>p</var>’ and ‘<var>q</var>’ are truth-functions of elementary propositions."
    ]
  },
  {
    "number": "5.32",
  ...
  },
  {
    "number": "5.42",
    "german": [
      "Dass <span class=\"mathrel\"><span class=\"symbol\">∨</span></span>, <span class=\"mathrel\"><span class=\"symbol\">⊃</span></span>, etc. nicht Beziehungen im Sinne von rechts und links etc. sind, leuchtet ein.",
      ...
      "Und es ist offenbar, dass das „<span class=\"symbol\">⊃</span>“, welches wir durch „<span class=\"mathop\">~</span>“ und „<span class=\"symbol\">∨</span>“ definieren, identisch ist mit dem, durch welches wir „<span class=\"symbol\">∨</span>“ mit „<span class=\"mathop\">~</span>“ definieren, und dass dieses „<span class=\"symbol\">∨</span>“ mit dem ersten identisch ist. U. s. w."
    ],
    "ogden": [
      "That <span class=\"mathrel\"><span class=\"symbol\">∨</span></span>, <span class=\"mathrel\"><span class=\"symbol\">⊃</span></span>, etc., are not relations in the sense of right and left, etc., is obvious.",
      ...
      "And it is obvious that the “<span class=\"symbol\">⊃</span>” which we define by means of “<span class=\"mathop\">~</span>” and “<span class=\"symbol\">∨</span>” is identical with that by which we define “<span class=\"symbol\">∨</span>” with the help of “<span class=\"mathop\">~</span>”, and that this “<span class=\"symbol\">∨</span>” is the same as the first, and so on."
    ],
    "pearsmcguinness": [
      "It is self-evident that <span class=\"mathrel\"><span class=\"symbol\">∨</span></span>, <span class=\"mathrel\"><span class=\"symbol\">⊃</span></span>, etc. are not relations in the sense in which right and left etc. are relations.",
      ...
      "And it is obvious that the ‘<span class=\"symbol\">⊃</span>’ defined by means of ‘<span class=\"mathop\">~</span>’ and ‘<span class=\"symbol\">∨</span>’ is identical with the one that figures with ‘<span class=\"mathop\">~</span>’ in the definition of ‘<span class=\"symbol\">∨</span>’; and that the second ‘<span class=\"symbol\">∨</span>’ is identical with the first one; and so on."
    ]
  },
  {
    "number": "5.43",
    "german": [
      "Dass aus einer Tatsache <var>p</var> unendlich viele <em class=\"germph\">andere</em> folgen sollten, nämlich <span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>, <span class=\"mathop\">~</span><span class=\"mathop\">~</span><span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>, etc., ist doch von vornherein kaum zu glauben. Und nicht weniger merkwürdig ist, dass die unendliche Anzahl der Sätze der Logik (der Mathematik) aus einem halben Dutzend „Grundgesetzen“ folgen.",
      "Alle Sätze der Logik sagen aber dasselbe. Nämlich nichts."
    ],
    "ogden": [
      "That from a fact <var>p</var> an infinite number of <em>others</em> should follow, namely, <span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>, <span class=\"mathop\">~</span><span class=\"mathop\">~</span><span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>, etc., is indeed hardly to be believed, and it is no less wonderful that the infinite number of propositions of logic (of mathematics) should follow from half a dozen “primitive propositions”.",
      "But the propositions of logic say the same thing. That is, nothing."
    ],
    "pearsmcguinness": [
      "Even at first sight it seems scarcely credible that there should follow from one fact <var>p</var> infinitely many <em>others</em>, namely <span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>, <span class=\"mathop\">~</span><span class=\"mathop\">~</span><span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>, etc. And it is no less remarkable that the infinite number of propositions of logic (mathematics) follow from half a dozen ‘primitive propositions’.",
  ...
  },
  {
    ...
    "german": [
      ...
      "Wenn man z. B. eine Bejahung durch doppelte Verneinung erzeugen kann, ist dann die Verneinung – in irgend einem Sinn – in der Bejahung enthalten? Verneint „<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>“ <span class=\"mathop\">~</span><var>p</var>, oder bejaht es <var>p</var>; oder beides?",
      "Der Satz „<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>“ handelt nicht von der Verneinung wie von einem Gegenstand; wohl aber ist die Möglichkeit der Verneinung in der Bejahung bereits präjudiziert.",
      "Und gäbe es einen Gegenstand, der „<span class=\"mathop\">~</span>“ hieße, so müsste „<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>“ etwas anderes sagen als „<var>p</var>“. Denn der eine Satz würde dann eben von <span class=\"mathop\">~</span> handeln, der andere nicht."
    ],
    "ogden": [
      "Truth-functions are not material functions.",
      "If <em>e.g.</em> an affirmation can be produced by repeated denial, is the denial—in any sense—contained in the affirmation? Does “<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>” deny <span class=\"mathop\">~</span><var>p</var>, or does it affirm <var>p</var>; or both?",
      "The proposition “<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>” does not treat of denial as an object, but the possibility of denial is already prejudged in affirmation.",
      "And if there was an object called “<span class=\"mathop\">~</span>”, then “<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>” would have to say something other than “<var>p</var>”. For the one proposition would then treat of <span class=\"mathop\">~</span>, the other would not."
    ],
    "pearsmcguinness": [
      "Truth-functions are not material functions.",
      "For example, an affirmation can be produced by double negation: in such a case does it follow that in some sense negation is contained in affirmation? Does ‘<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>’ negate <span class=\"mathop\">~</span><var>p</var>, or does it affirm <var>p</var>—or both?",
      "The proposition ‘<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>’ is not about negation, as if negation were an object: on the other hand, the possibility of negation is already written into affirmation.",
      "And if there were an object called ‘<span class=\"mathop\">~</span>’, it would follow that ‘<span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>’ said something different from what ‘<var>p</var>’ said, just because the one proposition would then be about <span class=\"mathop\">~</span> and the other would not."
    ]
  },
  {
    "number": "5.441",
    "german": [
      "Dieses Verschwinden der scheinbaren logischen Konstanten tritt auch ein, wenn „<span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><span class=\"mathop\">~</span><var>fx</var>“ dasselbe sagt wie „<span class=\"quant\">(<var>x</var>).</span><var>fx</var>“, oder „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var><span class=\"mathrel\">.</span><var>x</var><span class=\"mathrel\">=</span><var>a</var>“ dasselbe wie „<var>fa</var>“."
    ],
    "ogden": [
      "This disappearance of the apparent logical constants also occurs if “<span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><span class=\"mathop\">~</span><var>fx</var>” says the same as “<span class=\"quant\">(<var>x</var>).</span><var>fx</var>”, or “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var><span class=\"mathrel\">.</span><var>x</var><span class=\"mathrel\">=</span><var>a</var>” the same as “<var>fa</var>”."
    ],
    "pearsmcguinness": [
  ...
  },
  {
    "number": "5.451",
    "german": [
      "Hat die Logik Grundbegriffe, so müssen sie von einander unabhängig sein. Ist ein Grundbegriff eingeführt, so muss er in allen Verbindungen eingeführt sein, worin er überhaupt vorkommt. Man kann ihn also nicht zuerst für <em class=\"germph\">eine</em> Verbindung, dann noch einmal für eine andere einführen. Z. B.: Ist die Verneinung eingeführt, so müssen wir sie jetzt in Sätzen von der Form „<span class=\"mathop\">~</span><var>p</var>“ ebenso verstehen, wie in Sätzen wie „<span class=\"mathop\">~</span>(<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>)“, „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><span class=\"mathop\">~</span><var>fx</var>“ u.&nbsp;a. Wir dürfen sie nicht erst für die eine Klasse von Fällen, dann für die andere einführen, denn es bliebe dann zweifelhaft, ob ihre Bedeutung in beiden Fällen die gleiche wäre und es wäre kein Grund vorhanden, in beiden Fällen dieselbe Art der Zeichenverbindung zu benützen.",
    ...
    "pearsmcguinness": [
      ...
      "(In short, Frege’s remarks about introducing signs by means of definitions (in <i>The Fundamental Laws of Arithmetic</i>) also apply, <em>mutatis mutandis</em>, to the introduction of primitive signs.)"
    ]
  },
  {
    "number": "5.452",
    ...
    "pearsmcguinness": [
      ...
      "(Thus in Russell and Whitehead’s <i>Principia Mathematica</i> there occur definitions and primitive propositions expressed in words. Why this sudden appearance of words? It would require a justification, but none is given, or could be given, since the procedure is in fact illicit.)",
  ...
  },
  {
    ...
    "ogden": [
      "The apparently unimportant fact that the apparent relations like <span class=\"mathrel\"><span class=\"symbol\">∨</span></span> and <span class=\"mathrel\"><span class=\"symbol\">⊃</span></span> need brackets—unlike real relations—is of great importance.",
    ...
    "pearsmcguinness": [
      "Though it seems unimportant, it is in fact significant that the pseudo-relations of logic, such as <span class=\"mathrel\"><span class=\"symbol\">∨</span></span> and <span class=\"mathrel\"><span class=\"symbol\">⊃</span></span>, need brackets—unlike real relations.",
  ...
  },
  {
    ...
    "german": [
      ...
      "Sind ja schon im Elementarsatze alle logischen Operationen enthalten. Denn „<var>fa</var>“ sagt dasselbe wie",
      "<div class=\"displaymath\">„<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var><span class=\"mathrel\">.</span><var>x</var><span class=\"mathrel\">=</span><var>a</var>“.</div>",
    ...
    "ogden": [
      ...
      "For all logical operations are already contained in the elementary proposition. For “<var>fa</var>” says the same as",
      "<div class=\"displaymath\">“<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var><span class=\"mathrel\">.</span><var>x</var><span class=\"mathrel\">=</span><var>a</var>”.</div>",
    ...
    "pearsmcguinness": [
      ...
      "An elementary proposition really contains all logical operations in itself. For ‘<var>fa</var>’ says the same thing as",
      "<div class=\"displaymath\">‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var><span class=\"mathrel\">.</span><var>x</var><span class=\"mathrel\">=</span><var>a</var>’.</div>",
  ...
  },
  {
    "number": "5.5",
    "german": [
      "Jede Wahrheitsfunktion ist ein Resultat der successiven Anwendung der Operation <span class=\"mathop\">(-----<span class=\"mathrm\">W</span>)</span>(<var class=\"pushvar\">ξ</var>,&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.) auf Elementarsätze.",
      "Diese Operation verneint sämtliche Sätze in der rechten Klammer, und ich nenne sie die Negation dieser Sätze."
    ],
    "ogden": [
      "Every truth-function is a result of the successive application of the operation <span class=\"mathop\">(-----<span class=\"mathrm\">T</span>)</span>(<var class=\"pushvar\">ξ</var>,&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.) to elementary propositions.",
      "This operation denies all the propositions in the right-hand bracket and I call it the negation of these propositions."
    ],
    "pearsmcguinness": [
      "Every truth-function is a result of successive applications to elementary propositions of the operation ‘<span class=\"mathop\">(-----<span class=\"mathrm\">T</span>)</span>(<var class=\"pushvar\">ξ</var>,&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.)’.",
  ...
  },
  {
    "number": "5.501",
    "german": [
      "Einen Klammerausdruck, dessen Glieder Sätze sind, deute ich – wenn die Reihenfolge der Glieder in der Klammer gleichgültig ist – durch ein Zeichen von der Form „(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)“ an. „<var class=\"pushvar\">ξ</var>“ ist eine Variable, deren Werte die Glieder des Klammerausdruckes sind; und der Strich über der Variablen deutet an, dass sie ihre sämtlichen Werte in der Klammer vertritt.",
      "(Hat also <var>ξ</var> etwa die 3 Werte P, Q, R, so ist (<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span>(P, Q, R).)",
      ...
      "Wir <em class=\"germph\">können</em> drei Arten der Beschreibung unterscheiden: 1. Die direkte Aufzählung. In diesem Fall können wir statt der Variablen einfach ihre konstanten Werte setzen. 2. Die Angabe einer Funktion <var>fx</var>, deren Werte für alle Werte von <var>x</var> die zu beschreibenden Sätze sind. 3. Die Angabe eines formalen Gesetzes, nach welchem jene Sätze gebildet sind. In diesem Falle sind die Glieder des Klammerausdrucks sämtliche Glieder einer Formenreihe."
    ],
    "ogden": [
      ...
      "(Thus if <var>ξ</var> has the 3 values P, Q, R, then (<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span>(P, Q, R).)",
      ...
      "We may distinguish 3 kinds of description: 1. Direct enumeration. In this case we can place simply its constant values instead of the variable. 2. Giving a function <var>fx</var>, whose values for all values of <var>x</var> are the propositions to be described. 3. Giving a formal law, according to which those propositions are constructed. In this case the terms of the expression in brackets are all the terms of a formal series."
    ],
    "pearsmcguinness": [
      "When a bracketed expression has propositions as its terms—and the order of the terms inside the brackets is indifferent—then I indicate it by a sign of the form ‘(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)’. ‘<var class=\"pushvar\">ξ</var>’ is a variable whose values are terms of the bracketed expression and the bar over the variable indicates that it is the representative of all its values in the brackets.",
      "(E.g. if <var>ξ</var> has the three values P, Q, R, then (<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span>(P, Q, R). )",
      ...
      "We <em>can</em> distinguish three kinds of description: 1. direct enumeration, in which case we can simply substitute for the variable the constants that are its values; 2. giving a function <var>fx</var> whose values for all values of <var>x</var> are the propositions to be described; 3. giving a formal law that governs the construction of the propositions, in which case the bracketed expression has as its members all the terms of a series of forms."
    ]
  },
  {
    "number": "5.502",
    "german": [
      "Ich schreibe also statt „<span class=\"mathop\">(-----<span class=\"mathrm\">W</span>)</span>(<var class=\"pushvar\">ξ</var>,&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.)“ „<span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)“.",
      "<span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>) ist die Negation sämtlicher Werte der Satzvariablen <var class=\"pushvar\">ξ</var>."
    ],
    "ogden": [
      "Therefore I write instead of “<span class=\"mathop\">(-----<span class=\"mathrm\">T</span>)</span>(<var class=\"pushvar\">ξ</var>,&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.)”, “<span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)”.",
      "<span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>) is the negation of all the values of the propositional variable <var class=\"pushvar\">ξ</var>."
    ],
    "pearsmcguinness": [
      "So instead of ‘<span class=\"mathop\">(-----<span class=\"mathrm\">T</span>)</span>(<var class=\"pushvar\">ξ</var>,&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.)’, I write ‘<span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)’.",
      "<span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>) is the negation of all the values of the propositional variable <var class=\"pushvar\">ξ</var>."
    ]
  },
  {
  ...
  },
  {
    "number": "5.51",
    "german": [
      "Hat <var>ξ</var> nur einen Wert, so ist <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span><span class=\"mathop\">~</span><var>p</var> (nicht <var>p</var>), hat es zwei Werte, so ist <span class=\"nop\">N</span> (<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var> (weder <var>p</var> noch <var>q</var>)."
    ],
    "ogden": [
      "If <var>ξ</var> has only one value, then <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span><span class=\"mathop\">~</span><var>p</var> (not <var>p</var>), if it has two values then <span class=\"nop\">N</span> (<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var> (neither <var>p</var> nor <var>q</var>)."
    ],
    "pearsmcguinness": [
      "If <var>ξ</var> has only one value, then <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span><span class=\"mathop\">~</span><var>p</var> (not <var>p</var>); if it has two values, then <span class=\"nop\">N</span> (<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span><span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var> (neither <var>p</var> nor <var>q</var>)."
    ]
  ...
  },
  {
    "number": "5.512",
    "german": [
      "„<span class=\"mathop\">~</span><var>p</var>“ ist wahr, wenn „<var>p</var>“ falsch ist. Also in dem wahren Satz „<span class=\"mathop\">~</span><var>p</var>“ ist „<var>p</var>“ ein falscher Satz. Wie kann ihn nun der Strich „<span class=\"mathop\">~</span>“ mit der Wirklichkeit zum Stimmen bringen?",
      "Das, was in „<span class=\"mathop\">~</span><var>p</var>“ verneint, ist aber nicht das „<span class=\"mathop\">~</span>“, sondern dasjenige, was allen Zeichen dieser Notation, welche <var>p</var> verneinen, gemeinsam ist.",
      "Also die gemeinsame Regel, nach welcher „<span class=\"mathop\">~</span><var>p</var>“, „<span class=\"mathop\">~</span><span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>“, „<span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><span class=\"mathop\">~</span><var>p</var>“, „<span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>“, etc. etc. (ad inf.) gebildet werden. Und dies Gemeinsame spiegelt die Verneinung wieder."
    ],
    "ogden": [
      "“<span class=\"mathop\">~</span><var>p</var>” is true if “<var>p</var>” is false. Therefore in the true proposition “<span class=\"mathop\">~</span><var>p</var>” “<var>p</var>” is a false proposition. How then can the stroke “<span class=\"mathop\">~</span>” bring it into agreement with reality?",
      "That which denies in “<span class=\"mathop\">~</span><var>p</var>” is however not “<span class=\"mathop\">~</span>”, but that which all signs of this notation, which deny <var>p</var>, have in common.",
      "Hence the common rule according to which “<span class=\"mathop\">~</span><var>p</var>”, “<span class=\"mathop\">~</span><span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>”, “<span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><span class=\"mathop\">~</span><var>p</var>”, “<span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>”, etc. etc. (to infinity) are constructed. And this which is common to them all mirrors denial."
    ],
    "pearsmcguinness": [
      "‘<span class=\"mathop\">~</span><var>p</var>’ is true if ‘<var>p</var>’ is false. Therefore, in the proposition ‘<span class=\"mathop\">~</span><var>p</var>’, when it is true, ‘<var>p</var>’ is a false proposition. How then can the stroke ‘<span class=\"mathop\">~</span>’ make it agree with reality?",
      "But in ‘<span class=\"mathop\">~</span><var>p</var>’ it is not ‘<span class=\"mathop\">~</span>’ that negates, it is rather what is common to all the signs of this notation that negate <var>p</var>.",
      "That is to say the common rule that governs the construction of ‘<span class=\"mathop\">~</span><var>p</var>’, ‘<span class=\"mathop\">~</span><span class=\"mathop\">~</span><span class=\"mathop\">~</span><var>p</var>’, ‘<span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><span class=\"mathop\">~</span><var>p</var>’, ‘<span class=\"mathop\">~</span><var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>’, etc. etc. (ad inf.). And this common factor mirrors negation."
    ]
  },
  {
    "number": "5.513",
    "german": [
      "Man könnte sagen: Das Gemeinsame aller Symbole, die sowohl <var>p</var> als <var>q</var> bejahen, ist der Satz „<var>p</var><span class=\"mathrel\">.</span><var>q</var>“. Das Gemeinsame aller Symbole, die entweder <var>p</var> oder <var>q</var> bejahen, ist der Satz „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>“.",
      ...
      "Es zeigt sich so auch in Russells Notation, dass „<var>q</var><span class=\"mathrel\">:</span><var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><span class=\"mathop\">~</span><var>p</var>“ dasselbe sagt wie „<var>q</var>“; dass „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><span class=\"mathop\">~</span><var>p</var>“ nichts sagt."
    ],
    "ogden": [
      "We could say: What is common to all symbols, which assert both <var>p</var> and <var>q</var>, is the proposition “<var>p</var><span class=\"mathrel\">.</span><var>q</var>”. What is common to all symbols, which asserts either <var>p</var> or <var>q</var>, is the proposition “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>”.",
      ...
      "Thus in Russell’s notation also it appears evident that “<var>q</var><span class=\"mathrel\">:</span><var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><span class=\"mathop\">~</span><var>p</var>” says the same thing as “<var>q</var>”; that “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><span class=\"mathop\">~</span><var>p</var>” says nothing."
    ],
    "pearsmcguinness": [
      "We might say that what is common to all symbols that affirm both <var>p</var> and <var>q</var> is the proposition ‘<var>p</var><span class=\"mathrel\">.</span><var>q</var>’; and that what is common to all symbols that affirm either <var>p</var> or <var>q</var> is the proposition ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>’.",
      ...
      "Thus in Russell’s notation too it is manifest that ‘<var>q</var><span class=\"mathrel\">:</span><var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><span class=\"mathop\">~</span><var>p</var>’ says the same thing as ‘<var>q</var>’, that ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><span class=\"mathop\">~</span><var>p</var>’ says nothing."
    ]
  },
  {
    "number": "5.514",
    "german": [
      "Ist eine Notation festgelegt, so gibt es in ihr eine Regel, nach der alle <var>p</var> verneinenden Sätze gebildet werden, eine Regel, nach der alle <var>p</var> bejahenden Sätze gebildet werden, eine Regel, nach der alle <var>p</var> oder <var>q</var> bejahenden Sätze gebildet werden, u.&nbsp;s.&nbsp;f. Diese Regeln sind den Symbolen äquivalent und in ihnen spiegelt sich ihr Sinn wieder."
    ],
    "ogden": [
      "If a notation is fixed, there is in it a rule according to which all the propositions denying <var>p</var> are constructed, a rule according to which all the propositions asserting <var>p</var> are constructed, a rule according to which all the propositions asserting <var>p</var> or <var>q</var> are constructed, and so on. These rules are equivalent to the symbols and in them their sense is mirrored."
    ],
    "pearsmcguinness": [
      "Once a notation has been established, there will be in it a rule governing the construction of all propositions that negate <var>p</var>, a rule governing the construction of all propositions that affirm <var>p</var>, and a rule governing the construction of all propositions that affirm <var>p</var> or <var>q</var>; and so on. These rules are equivalent to the symbols; and in them their sense is mirrored."
    ]
  },
  {
    "number": "5.515",
    "german": [
      "Es muss sich an unseren Symbolen zeigen, dass das, was durch „<span class=\"symbol\">∨</span>“, „<span class=\"mathrel\">.</span>“, etc. miteinander verbunden ist, Sätze sein müssen.",
      "Und dies ist auch der Fall, denn das Symbol „<var>p</var>“ und „<var>q</var>“ setzt ja selbst das „<span class=\"symbol\">∨</span>“, „<span class=\"mathop\">~</span>“, etc. voraus. Wenn das Zeichen „<var>p</var>“ in „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>“ nicht für ein komplexes Zeichen steht, dann kann es allein nicht Sinn haben; dann können aber auch die mit „<var>p</var>“ gleichsinnigen Zeichen „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>p</var>“, „<var>p</var><span class=\"mathrel\">.</span><var>p</var>“, etc. keinen Sinn haben. Wenn aber „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>p</var>“ keinen Sinn hat, dann kann auch „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>“ keinen Sinn haben."
    ],
    "ogden": [
      "It must be recognized in our symbols that what is connected by “<span class=\"symbol\">∨</span>”, “<span class=\"mathrel\">.</span>”, etc., must be propositions.",
      "And this is the case, for the symbols “<var>p</var>” and “<var>q</var>” presuppose “<span class=\"symbol\">∨</span>”, “<span class=\"mathop\">~</span>”, etc. If the sign “<var>p</var>” in “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>” does not stand for a complex sign, then by itself it cannot have sense; but then also the signs “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>p</var>”, “<var>p</var><span class=\"mathrel\">.</span><var>p</var>”, etc. which have the same sense as “<var>p</var>” have no sense. If, however, “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>p</var>” has no sense, then also “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>” can have no sense."
    ],
    "pearsmcguinness": [
      "It must be manifest in our symbols that it can only be propositions that are combined with one another by ‘<span class=\"symbol\">∨</span>’, ‘<span class=\"mathop\">~</span>’, etc.",
      "And this is indeed the case, since the symbol in ‘<var>p</var>’ and ‘<var>q</var>’ itself presupposes ‘<span class=\"symbol\">∨</span>’, ‘<span class=\"mathop\">~</span>’, etc. If the sign ‘<var>p</var>’ in ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>’ does not stand for a complex sign, then it cannot have sense by itself: but in that case the signs ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>p</var>’, ‘<var>p</var><span class=\"mathrel\">.</span><var>p</var>’, etc., which have the same sense as <var>p</var>, must also lack sense. But if ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>p</var>’ has no sense, then ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">∨</span></span><var>q</var>’ cannot have a sense either."
    ]
  },
  {
    "number": "5.5151",
    "german": [
      "Muss das Zeichen des negativen Satzes mit dem Zeichen des positiven gebildet werden? Warum sollte man den negativen Satz nicht durch eine negative Tatsache ausdrücken können. (Etwa: Wenn „<var>a</var>“ nicht in einer bestimmten Beziehung zu „<var>b</var>“ steht, könnte das ausdrücken, dass <var>aRb</var> nicht der Fall ist.)",
    ...
    "ogden": [
      "Must the sign of the negative proposition be constructed by means of the sign of the positive? Why should one not be able to express the negative proposition by means of a negative fact? (Like: if “<var>a</var>” does not stand in a certain relation to “<var>b</var>”, it could express that <var>aRb</var> is not the case.)",
  ...
  },
  {
    "number": "5.52",
    "german": [
      "Sind die Werte von <var>ξ</var> sämtliche Werte einer Funktion <var>fx</var> für alle Werte von <var>x</var>, so wird <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span><span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var>."
    ],
    "ogden": [
      "If the values of <var>ξ</var> are the total values of a function <var>fx</var> for all values of <var>x</var>, then <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span><span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var>."
    ],
    "pearsmcguinness": [
      "If <var>ξ</var> has as its values all the values of a function <var>fx</var> for all values of <var>x</var>, then <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)<span class=\"mathrel\">=</span><span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var>."
    ]
  },
  {
    "number": "5.521",
    "german": [
      ...
      "Frege und Russell haben die Allgemeinheit in Verbindung mit dem logischen Produkt oder der logischen Summe eingeführt. So wurde es schwer, die Sätze „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var>“ und „<span class=\"quant\">(<var>x</var>).</span><var>fx</var>“, in welchen beide Ideen beschlossen liegen, zu verstehen."
    ],
    "ogden": [
      "I separate the concept <em>all</em> from the truth-function.",
      "Frege and Russell have introduced generality in connexion with the logical product or the logical sum. Then it would be difficult to understand the propositions “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var>” and “<span class=\"quant\">(<var>x</var>).</span><var>fx</var>” in which both ideas lie concealed."
    ],
    "pearsmcguinness": [
      "I dissociate the concept <em>all</em> from truth-functions.",
      "Frege and Russell introduced generality in association with logical product or logical sum. This made it difficult to understand the propositions ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var>’ and ‘<span class=\"quant\">(<var>x</var>).</span><var>fx</var>’, in which both ideas are embedded."
    ]
  },
  {
    "number": "5.522",
  ...
  },
  {
    "number": "5.525",
    "german": [
      "Es ist unrichtig, den Satz „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var>“ – wie Russell dies tut – in Worten durch „<var>fx</var> ist <em class=\"germph\">möglich</em>“ wiederzugeben.",
    ...
    "ogden": [
      "It is not correct to render the proposition “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var>”—as Russell does—in the words “<var>fx</var> is <em>possible</em>”.",
    ...
    "pearsmcguinness": [
      "It is incorrect to render the proposition ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var>’ in the words, ‘<var>fx</var> is <em>possible</em>’ as Russell does.",
  ...
  },
  {
    ...
    "german": [
      ...
      "Um dann auf die gewöhnliche Ausdrucksweise zu kommen, muss man einfach nach einem Ausdruck: „Es gibt ein und nur ein <var>x</var>, welches …“ sagen: Und dies <var>x</var> ist <var>a</var>."
    ],
    "ogden": [
      ...
      "In order then to arrive at the customary way of expression we need simply say after an expression “there is one and only one <var>x</var>, which …”: and this <var>x</var> is <var>a</var>."
    ],
    "pearsmcguinness": [
      ...
      "Then, in order to arrive at the customary mode of expression, we simply need to add, after an expression like, ‘There is one and only one <var>x</var> such that …’, the words, ‘and that <var>x</var> is <var>a</var>’."
    ]
  },
  {
    "number": "5.5261",
    "german": [
      "Ein vollkommen verallgemeinerter Satz ist, wie jeder andere Satz, zusammengesetzt. (Dies zeigt sich daran, dass wir in „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>, <var>ϕ</var>).</span><var>ϕx</var>“ „<var>ϕ</var>“ und „<var>x</var>“ getrennt erwähnen müssen. Beide stehen unabhängig in bezeichnenden Beziehungen zur Welt, wie im unverallgemeinerten Satz.)",
    ...
    "pearsmcguinness": [
      "A fully generalized proposition, like every other proposition, is composite. (This is shown by the fact that in ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>, <var>ϕ</var>).</span><var>ϕx</var>’ we have to mention ‘<var>ϕ</var>’ and ‘<var>x</var>’ separately. They both, independently, stand in signifying relations to the world, just as is the case in ungeneralized propositions.)",
  ...
  },
  {
    "number": "5.5301",
    "german": [
      "Dass die Identität keine Relation zwischen Gegenständen ist, leuchtet ein. Dies wird sehr klar, wenn man z.&nbsp;B. den Satz „<span class=\"quant\">(<var>x</var>):</span><var>fx</var><span class=\"mathrel\">.<span class=\"symbol\">⊃</span>.</span><var>x</var><span class=\"mathrel\">=</span><var>a</var>“ betrachtet. Was dieser Satz sagt, ist einfach, dass <em class=\"germph\">nur</em> <var>a</var> der Funktion <var>f</var> genügt, und nicht, dass nur solche Dinge der Funktion <var>f</var> genügen, welche eine gewisse Beziehung zu <var>a</var> haben.",
      "Man könnte nun freilich sagen, dass eben <em class=\"germph\">nur</em> <var>a</var> diese Beziehung zu <var>a</var> habe, aber, um dies auszudrücken, brauchten wir das Gleichheitszeichen selber."
    ],
    "ogden": [
      "That identity is not a relation between objects is obvious. This becomes very clear if, for example, one considers the proposition “<span class=\"quant\">(<var>x</var>):</span><var>fx</var><span class=\"mathrel\">.<span class=\"symbol\">⊃</span>.</span><var>x</var><span class=\"mathrel\">=</span><var>a</var>”. What this proposition says is simply that <em>only</em> <var>a</var> satisfies the function <var>f</var>, and not that only such things satisfy the function <var>f</var> which have a certain relation to <var>a</var>.",
      "One could of course say that in fact <em>only</em> <var>a</var> has this relation to <var>a</var>, but in order to express this we should need the sign of identity itself."
    ],
    "pearsmcguinness": [
      "It is self-evident that identity is not a relation between objects. This becomes very clear if one considers, for example, the proposition ‘<span class=\"quant\">(<var>x</var>):</span><var>fx</var><span class=\"mathrel\">.<span class=\"symbol\">⊃</span>.</span><var>x</var><span class=\"mathrel\">=</span><var>a</var>’. What this proposition says is simply that <em>only</em> <var>a</var> satisfies the function <var>f</var>, and not that only things that have a certain relation to <var>a</var> satisfy the function <var>f</var>.",
      "Of course, it might then be said that <em>only</em> <var>a</var> did have this relation to <var>a</var>; but in order to express that, we should need the identity-sign itself."
    ]
  },
  {
    "number": "5.5302",
  ...
  },
  {
    "number": "5.531",
    "german": [
      "Ich schreibe also nicht „<var class=\"pushvar\">f</var>(<var>a</var>,<var>b</var>)<span class=\"mathrel\">.</span><var>a</var><span class=\"mathrel\">=</span><var>b</var>“, sondern „<var class=\"pushvar\">f</var>(<var>a</var>,<var>a</var>)“ (oder „<var class=\"pushvar\">f</var>(<var>b</var>,<var>b</var>)“). Und nicht „<var class=\"pushvar\">f</var>(<var>a</var>,<var>b</var>)<span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>a</var><span class=\"mathrel\">=</span><var>b</var>“, sondern „<var class=\"pushvar\">f</var>(<var>a</var>,<var>b</var>)“."
    ],
    "ogden": [
      "I write therefore not “<var class=\"pushvar\">f</var>(<var>a</var>,<var>b</var>)<span class=\"mathrel\">.</span><var>a</var><span class=\"mathrel\">=</span><var>b</var>” but “<var class=\"pushvar\">f</var>(<var>a</var>,<var>a</var>)” (or “<var class=\"pushvar\">f</var>(<var>b</var>,<var>b</var>)”). And not “<var class=\"pushvar\">f</var>(<var>a</var>,<var>b</var>)<span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>a</var><span class=\"mathrel\">=</span><var>b</var>”, but “<var class=\"pushvar\">f</var>(<var>a</var>,<var>b</var>)”."
    ],
    "pearsmcguinness": [
      "Thus I do not write ‘<var class=\"pushvar\">f</var>(<var>a</var>,<var>b</var>)<span class=\"mathrel\">.</span><var>a</var><span class=\"mathrel\">=</span><var>b</var>’, but ‘<var class=\"pushvar\">f</var>(<var>a</var>,<var>a</var>)’ (or ‘<var class=\"pushvar\">f</var>(<var>b</var>,<var>b</var>)’); and not ‘<var class=\"pushvar\">f</var>(<var>a</var>,<var>b</var>)<span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>a</var><span class=\"mathrel\">=</span><var>b</var>’, but ‘<var class=\"pushvar\">f</var>(<var>a</var>,<var>b</var>)’."
    ]
  },
  {
    "number": "5.532",
    "german": [
      "Und analog: Nicht „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)<span class=\"mathrel\">.</span><var>x</var><span class=\"mathrel\">=</span><var>y</var>“, sondern „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>x</var>)“; und nicht „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)<span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>x</var><span class=\"mathrel\">=</span><var>y</var>“, sondern „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)“.",
      "(Also statt des Russellschen „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)“: „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)<span class=\"mathrel\">.<span class=\"symbol\">∨</span>.</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>x</var>)“.)"
    ],
    "ogden": [
      "And analogously: not “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)<span class=\"mathrel\">.</span> <var>x</var><span class=\"mathrel\">=</span><var>y</var>”, but “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>x</var>)”; and not “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)<span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>x</var><span class=\"mathrel\">=</span><var>y</var>”, but “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)”.",
      "(Therefore instead of Russell’s “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)”: “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)<span class=\"mathrel\">.<span class=\"symbol\">∨</span>.</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>x</var>)”.)"
    ],
    "pearsmcguinness": [
      "And analogously I do not write ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)<span class=\"mathrel\">.</span><var>x</var><span class=\"mathrel\">=</span><var>y</var>’, but ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>x</var>)’; and not ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)<span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>x</var><span class=\"mathrel\">=</span><var>y</var>’, but ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)’.",
      "(So Russell’s ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)’ becomes ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>y</var>)<span class=\"mathrel\">.<span class=\"symbol\">∨</span>.</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var class=\"pushvar\">f</var>(<var>x</var>,<var>x</var>)’.)"
    ]
  },
  {
    "number": "5.5321",
    "german": [
      "Statt „<span class=\"quant\">(<var>x</var>):</span><var>fx</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>x</var><span class=\"mathrel\">=</span><var>a</var>“ schreiben wir also z.&nbsp;B. „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var><span class=\"mathrel\">.<span class=\"symbol\">⊃</span>.</span><var>fa</var><span class=\"mathrel\">:</span><span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var>fx</var><span class=\"mathrel\">.</span><var>fy</var>“.",
      "Und der Satz: „<em class=\"germph\">nur</em> Ein <var>x</var> befriedigt <var class=\"pushvar\">f</var>(&nbsp;)“ lautet: „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var><span class=\"mathrel\">:</span><span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var>fx</var><span class=\"mathrel\">.</span><var>fy</var>“."
    ],
    "ogden": [
      "Instead of “<span class=\"quant\">(<var>x</var>):</span><var>fx</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>x</var><span class=\"mathrel\">=</span><var>a</var>” we therefore write <em>e.g.</em> “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var><span class=\"mathrel\">.<span class=\"symbol\">⊃</span>.</span><var>fa</var><span class=\"mathrel\">:</span><span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var>fx</var><span class=\"mathrel\">.</span><var>fy</var>”.",
      "And if the proposition “<em>only</em> one <var>x</var> satisfies <var class=\"pushvar\">f</var>(&nbsp;)” reads: “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var><span class=\"mathrel\">:</span><span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var>fx</var><span class=\"mathrel\">.</span><var>fy</var>”."
    ],
    "pearsmcguinness": [
      "Thus, for example, instead of ‘<span class=\"quant\">(<var>x</var>):</span><var>fx</var> <span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>x</var><span class=\"mathrel\">=</span><var>a</var>’ we write ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var><span class=\"mathrel\">.<span class=\"symbol\">⊃</span>.</span><var>fa</var><span class=\"mathrel\">:</span><span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var>fx</var><span class=\"mathrel\">.</span><var>fy</var>’.",
      "And the proposition, ‘<em>Only one</em> <var>x</var> satisfies <var class=\"pushvar\">f</var>(&nbsp;)’, will read ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>fx</var><span class=\"mathrel\">:</span><span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>,<var>y</var>).</span><var>fx</var><span class=\"mathrel\">.</span><var>fy</var>’."
    ]
  },
  {
    "number": "5.533",
  ...
  },
  {
    "number": "5.534",
    "german": [
      "Und nun sehen wir, dass Scheinsätze wie: „<var>a</var><span class=\"mathrel\">=</span><var>a</var>“, „<var>a</var><span class=\"mathrel\">=</span><var>b</var><span class=\"mathrel\">.</span><var>b</var><span class=\"mathrel\">=</span><var>c</var><span class=\"mathrel\">.<span class=\"symbol\">⊃</span></span><var>a</var><span class=\"mathrel\">=</span><var>c</var>“, „<span class=\"quant\">(<var>x</var>).</span><var>x</var><span class=\"mathrel\">=</span><var>x</var>“, „<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>x</var><span class=\"mathrel\">=</span><var>a</var>“, etc. sich in einer richtigen Begriffsschrift gar nicht hinschreiben lassen."
    ],
    "ogden": [
      "And we see that the apparent propositions like: “<var>a</var><span class=\"mathrel\">=</span><var>a</var>”, “<var>a</var><span class=\"mathrel\">=</span><var>b</var><span class=\"mathrel\">.</span><var>b</var><span class=\"mathrel\">=</span><var>c</var><span class=\"mathrel\">.<span class=\"symbol\">⊃</span></span><var>a</var><span class=\"mathrel\">=</span><var>c</var>”, “<span class=\"quant\">(<var>x</var>).</span><var>x</var><span class=\"mathrel\">=</span><var>x</var>”. “<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>x</var><span class=\"mathrel\">=</span><var>a</var>”, etc. cannot be written in a correct logical notation at all."
    ],
    "pearsmcguinness": [
      "And now we see that in a correct conceptual notation pseudo-propositions like ‘<var>a</var><span class=\"mathrel\">=</span><var>a</var>’, ‘<var>a</var><span class=\"mathrel\">=</span><var>b</var><span class=\"mathrel\">.</span><var>b</var><span class=\"mathrel\">=</span><var>c</var><span class=\"mathrel\">.<span class=\"symbol\">⊃</span></span><var>a</var><span class=\"mathrel\">=</span><var>c</var>’, ‘<span class=\"quant\">(<var>x</var>).</span><var>x</var><span class=\"mathrel\">=</span><var>x</var>’, ‘<span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>x</var><span class=\"mathrel\">=</span><var>a</var>’, etc. cannot even be written down."
    ]
  },
  {
    "number": "5.535",
  ...
  },
  {
    "number": "5.5351",
    "german": [
      "Es gibt gewisse Fälle, wo man in Versuchung gerät, Ausdrücke von der Form „<var>a</var><span class=\"mathrel\">=</span><var>a</var>“ oder „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var>“ u. dgl. zu benützen. Und zwar geschieht dies, wenn man von dem Urbild: Satz, Ding, etc. reden möchte. So hat Russell in den „Principles of Mathematics“ den Unsinn „<var>p</var> ist ein Satz“ in Symbolen durch „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var>“ wiedergegeben und als Hypothese vor gewisse Sätze gestellt, damit deren Argumentstellen nur von Sätzen besetzt werden könnten.",
      "(Es ist schon darum Unsinn, die Hypothese <var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var> vor einen Satz zu stellen, um ihm Argumente der richtigen Form zu sichern, weil die Hypothese für einen Nicht-Satz als Argument nicht falsch, sondern unsinnig wird, und weil der Satz selbst durch die unrichtige Gattung von Argumenten unsinnig wird, also sich selbst ebenso gut, oder so schlecht, vor den unrechten Argumenten bewahrt wie die zu diesem Zweck angehängte sinnlose Hypothese.)"
    ],
    "ogden": [
      "There are certain cases in which one is tempted to use expressions of the form “<var>a</var><span class=\"mathrel\">=</span><var>a</var>” or “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var>”. As, for instance, when one would speak of the archetype Proposition, Thing, etc. So Russell in the <em>Principles of Mathematics</em> has rendered the nonsense “<var>p</var> is a proposition” in symbols by “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var>” and has put it as hypothesis before certain propositions to show that their places for arguments could only be occupied by propositions.",
      "(It is nonsense to place the hypothesis <var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var> before a proposition in order to ensure that its arguments have the right form, because the hypotheses for a non-proposition as argument becomes not false but meaningless, and because the proposition itself becomes senseless for arguments of the wrong kind, and therefore it survives the wrong arguments no better and no worse than the senseless hypothesis attached for this purpose.)"
    ],
    "pearsmcguinness": [
      "There are certain cases in which one is tempted to use expressions of the form ‘<var>a</var><span class=\"mathrel\">=</span><var>a</var>’ or ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var>’ and the like. In fact, this happens when one wants to talk about prototypes, e.g. about proposition, thing, etc. Thus in Russell’s <i>Principles of Mathematics</i> ‘<var>p</var> is a proposition’—which is nonsense—was given the symbolic rendering ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var>’ and placed as an hypothesis in front of certain propositions in order to exclude from their argument-places everything but propositions.",
      "(It is nonsense to place the hypothesis ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>p</var>’ in front of a proposition, in order to ensure that its arguments shall have the right form, if only because with a non-proposition as argument the hypothesis becomes not false but nonsensical, and because arguments of the wrong kind make the proposition itself nonsensical, so that it preserves itself from wrong arguments just as well, or as badly, as the hypothesis without sense that was appended for that purpose.)"
    ]
  },
  {
    "number": "5.5352",
    ...
    "ogden": [
      "Similarly it was proposed to express “There are no things” by “<span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>x</var><span class=\"mathrel\">=</span><var>x</var>”. But even if this were a proposition—would it not be true if indeed “There were things”, but these were not identical with themselves?"
    ],
    "pearsmcguinness": [
      "In the same way people have wanted to express, ‘There are no <em>things</em>’, by writing ‘<span class=\"mathop\">~</span><span class=\"quant\">(<span class=\"symbol\">∃</span><var>x</var>).</span><var>x</var><span class=\"mathrel\">=</span><var>x</var>’. But even if this were a proposition, would it not be equally true if in fact ‘there were things’ but they were not identical with themselves?"
    ]
  },
  {
    "number": "5.54",
  ...
  },
  {
    ...
    "german": [
      ...
      "Besonders in gewissen Satzformen der Psychologie, wie „A glaubt, dass <var>p</var> der Fall ist“, oder „A denkt <var>p</var>“, etc.",
      "Hier scheint es nämlich oberflächlich, als stünde der Satz <var>p</var> zu einem Gegenstand A in einer Art von Relation.",
    ...
    "ogden": [
      ...
      "Especially in certain propositional forms of psychology, like “A thinks, that <var>p</var> is the case”, or “A thinks <var>p</var>”, etc.",
      "Here it appears superficially as if the proposition <var>p</var> stood to the object A in a kind of relation.",
    ...
    "pearsmcguinness": [
      ...
      "Particularly with certain forms of proposition in psychology, such as ‘A believes that <var>p</var> is the case’ and A has the thought <var>p</var>’, etc.",
      "For if these are considered superficially, it looks as if the proposition <var>p</var> stood in some kind of relation to an object A.",
  ...
  },
  {
    "number": "5.542",
    "german": [
      "Es ist aber klar, dass „A glaubt, dass <var>p</var>“, „A denkt <var>p</var>“, „A sagt <var>p</var>“ von der Form „‚<var>p</var>‘ sagt <var>p</var>“ sind: Und hier handelt es sich nicht um eine Zuordnung von einer Tatsache und einem Gegenstand, sondern um die Zuordnung von Tatsachen durch Zuordnung ihrer Gegenstände."
    ],
    "ogden": [
      "But it is clear that “A believes that <var>p</var>”, “A thinks <var>p</var>”, “A says <var>p</var>”, are of the form “‘<var>p</var>’ says <var>p</var>”: and here we have no co-ordination of a fact and an object, but a co-ordination of facts by means of a co-ordination of their objects."
    ],
    "pearsmcguinness": [
      "It is clear, however, that ‘A believes that <var>p</var>’, ‘A has the thought <var>p</var>’, and ‘A says <var>p</var>’ are of the form ‘“<var>p</var>” says <var>p</var>’: and this does not involve a correlation of a fact with an object, but rather the correlation of facts by means of the correlation of their objects."
    ]
  },
  {
    "number": "5.5421",
  ...
  },
  {
    "number": "5.5422",
    "german": [
      "Die richtige Erklärung der Form des Satzes „A urteilt <var>p</var>“ muss zeigen, dass es unmöglich ist, einen Unsinn zu urteilen. (Russells Theorie genügt dieser Bedingung nicht.)"
    ],
    "ogden": [
      "The correct explanation of the form of the proposition “A judges <var>p</var>” must show that it is impossible to judge a nonsense. (Russell’s theory does not satisfy this condition.)"
    ],
    "pearsmcguinness": [
      "The correct explanation of the form of the proposition, ‘A makes the judgement <var>p</var>’, must show that it is impossible for a judgement to be a piece of nonsense. (Russell’s theory does not satisfy this requirement.)"
    ]
  },
  {
    "number": "5.5423",
    "german": [
      ...
      "Dies erklärt wohl auch, dass man die Figur\n<div class=\"centered\"><object data=\"images/thecube.svg\" type=\"image/svg+xml\" class=\"thecubesvg\"><img src=\"images/thecube.png\" alt=\"Cube with a face and b face\" class=\"thecubepng\"></object></div>",
      ...
      "(Sehe ich erst auf die Ecken <var>a</var> und nur flüchtig auf <var>b</var>, so erscheint <var>a</var> vorne; und umgekehrt.)"
    ],
    "ogden": [
      ...
      "(If I fix my eyes first on the corners <var>a</var> and only glance at <var>b</var>, <var>a</var> appears in front and <var>b</var> behind, and vice versa.)"
    ],
    "pearsmcguinness": [
      ...
      "(If I look in the first place at the corners marked <var>a</var> and only glance at the <var>b</var>’s, then the <var>a</var>’s appear to be in front, and <em>vice versa</em>)."
    ]
  },
  {
    "number": "5.55",
    ...
    "pearsmcguinness": [
      "We now have to answer <i>a priori</i> the question about all the possible forms of elementary propositions.",
  ...
  },
  {
    "number": "5.6331",
    "german": [
      "Das Gesichtsfeld hat nämlich nicht etwa eine solche Form:\n<div class=\"centered\"><span class=\"sfmiddle\"><span class=\"lowered\">Auge —</span><object data=\"images/theeye.svg\" type=\"image/svg+xml\" class=\"theeyesvg\"><img src=\"images/theeye.png\" alt=\"Eye image\" class=\"theeyepng\"></object></span></div>"
    ],
    "ogden": [
      "For the field of sight has not a form like this: <div class=\"centered\"><span class=\"sfmiddle\"><span class=\"lowered\">Eye —</span><object data=\"images/theeye.svg\" type=\"image/svg+xml\" class=\"theeyesvg\"><img src=\"images/theeye.png\" alt=\"Eye image\" class=\"theeyepng\"></object></span></div>"
    ],
    "pearsmcguinness": [
      "For the form of the visual field is surely not like this <div class=\"centered\"><span class=\"sfmiddle\"><span class=\"lowered\">Eye —</span><object data=\"images/theeye.svg\" type=\"image/svg+xml\" class=\"theeyesvg\"><img src=\"images/theeye.png\" alt=\"Eye image\" class=\"theeyepng\"></object></span></div>"
    ]
  },
  {
    "number": "5.634",
    ...
    "pearsmcguinness": [
      "This is connected with the fact that no part of our experience is at the same time <i>a priori</i>.",
      "Whatever we see could be other than it is.",
      "Whatever we can describe at all could be other than it is.",
      "There is no <i>a priori</i> order of things."
    ]
  },
  {
    "number": "5.64",
  ...
  },
  {
    "number": "6",
    "german": [
      "Die allgemeine Form der Wahrheitsfunktion ist: [<span class=\"overlined\"><var>p</var></span>,  <span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>,  <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)].",
      "Dies ist die allgemeine Form des Satzes."
    ],
    "ogden": [
      "The general form of truth-function is: [<span class=\"overlined\"><var>p</var></span>,  <span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>,  <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)].",
      "This is the general form of proposition."
    ],
    "pearsmcguinness": [
      "The general form of a truth-function is  [<span class=\"overlined\"><var>p</var></span>,  <span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>,  <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)].",
  ...
  },
  {
    "number": "6.001",
    "german": [
      "Dies sagt nichts anderes, als dass jeder Satz ein Resultat der successiven Anwendung der Operation <span class=\"mathop\"><span class=\"nop\">N</span>’</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>) auf die Elementarsätze ist."
    ],
    "ogden": [
      "This says nothing else than that every proposition is the result of successive applications of the operation <span class=\"mathop\"><span class=\"nop\">N</span>’</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>) to the elementary propositions."
    ],
    "pearsmcguinness": [
      "What this says is just that every proposition is a result of successive applications to elementary propositions of the operation <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)."
    ]
  },
  {
    "number": "6.002",
  ...
  },
  {
    "number": "6.01",
    "german": [
      "Die allgemeine Form der Operation <span class=\"mathop\">Ω’</span>(<span class=\"overlined\"><var>η</var></span>) ist also: <span class=\"mathop\">[<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>,  <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)]’</span>(<span class=\"overlined\"><var>η</var></span>) (<span class=\"mathrel\">=</span>[<span class=\"overlined\"><var>η</var></span>,  <span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>,  <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)]).",
      "Das ist die allgemeinste Form des Überganges von einem Satz zum anderen."
    ],
    "ogden": [
      "The general form of the operation <span class=\"mathop\">Ω’</span>(<span class=\"overlined\"><var>η</var></span>) is therefore: <span class=\"mathop\">[<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>,  <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)]’</span>(<span class=\"overlined\"><var>η</var></span>) (<span class=\"mathrel\">=</span>[<span class=\"overlined\"><var>η</var></span>,  <span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>,  <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)]).",
      "This is the most general form of transition from one proposition to another."
    ],
    "pearsmcguinness": [
      "Therefore the general form of an operation <span class=\"mathop\">Ω’</span>(<span class=\"overlined\"><var>η</var></span>) is <span class=\"mathop\">[<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>,  <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)]’</span>(<span class=\"overlined\"><var>η</var></span>) (<span class=\"mathrel\">=</span>[<span class=\"overlined\"><var>η</var></span>,  <span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>,  <span class=\"nop\">N</span>(<span class=\"overlined\"><var class=\"pushvar\">ξ</var></span>)]).",
      "This is the most general form of transition from one proposition to another."
    ]
  },
  {
    ...
    "german": [
      ...
      "<div class=\"centered\"><table class=\"alignedmath\"><tbody><tr><td class=\"righttight\"><var>x</var><span class=\"mathrel\">=</span></td><td class=\"lefttight\"><span class=\"mathop\">Ω<sup>0</sup>’</span><var>x</var>&nbsp;&nbsp;Def. und</td></tr><tr><td class=\"righttight\"><span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω<sup><var>ν</var></sup>’</span><var>x</var><span class=\"mathrel\">=</span></td><td class=\"lefttight\"><span class=\"mathop\">Ω<sup><var>ν</var>+1</sup>’</span><var>x</var>&nbsp;&nbsp;Def.</td></tr></tbody></table></div>",
      "Nach diesen Zeichenregeln schreiben wir also die Reihe",
      "<div class=\"displaymath\"><var>x</var>,  <span class=\"mathop\">Ω’</span><var>x</var>,  <span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><var>x</var>,  <span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><var>x</var>,<span class=\"mathrel\">…</span></div>",
      "so:",
      "<div class=\"displaymath\"><span class=\"mathop\">Ω<sup>0</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup>0+1</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup>0+1+1</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup>0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1</sup>’</span><var>x</var>,<span class=\"mathrel\">…</span></div>",
      "Also schreibe ich statt „[<var>x</var>,  <var class=\"pushvar\">ξ</var>,  <span class=\"mathop\">Ω’</span><var class=\"pushvar\">ξ</var>]“:",
      "<div class=\"displaymath\">„[<span class=\"mathop\">Ω<sup>0</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup><var>ν</var></sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup><var>ν</var><span class=\"mathrel\">+</span>1</sup>’</span><var>x</var>]“.</div>",
      "Und definiere:",
      "<div class=\"centered\"><table class=\"alignedmath\"><tbody><tr><td class=\"lefttight\">0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">=</span>1&nbsp;&nbsp;Def.</td></tr><tr><td class=\"lefttight\">0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">=</span>2&nbsp;&nbsp;Def.</td></tr><tr><td class=\"lefttight\">0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">=</span>3&nbsp;&nbsp;Def.</td></tr><tr><td class=\"lefttight\">(u. s. f.)</td></tr></tbody></table></div>"
    ],
    "ogden": [
      "And thus we come to numbers: I define",
      "<div class=\"centered\"><table class=\"alignedmath\"><tbody><tr><td class=\"righttight\"><var>x</var><span class=\"mathrel\">=</span></td><td class=\"lefttight\"><span class=\"mathop\">Ω<sup>0</sup>’</span><var>x</var>&nbsp;&nbsp;Def. and</td></tr><tr><td class=\"righttight\"><span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω<sup><var>ν</var></sup>’</span><var>x</var><span class=\"mathrel\">=</span></td><td class=\"lefttight\"><span class=\"mathop\">Ω<sup><var>ν</var>+1</sup>’</span><var>x</var>&nbsp;&nbsp;Def.</td></tr></tbody></table></div>",
      "According, then, to these symbolic rules we write the series",
      "<div class=\"displaymath\"><var>x</var>,  <span class=\"mathop\">Ω’</span><var>x</var>,  <span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><var>x</var>,  <span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><var>x</var>,<span class=\"mathrel\">…</span></div>",
      "as:",
      "<div class=\"displaymath\"><span class=\"mathop\">Ω<sup>0</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup>0+1</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup>0+1+1</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup>0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1</sup>’</span><var>x</var>,<span class=\"mathrel\">…</span></div>",
      "Therefore I write in place of “[<var>x</var>,  <var class=\"pushvar\">ξ</var>, <span class=\"mathop\">Ω’</span><var class=\"pushvar\">ξ</var>]”,",
      "<div class=\"displaymath\">“[<span class=\"mathop\">Ω<sup>0</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup><var>ν</var></sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup><var>ν</var><span class=\"mathrel\">+</span>1</sup>’</span><var>x</var>]”.</div>",
      "And I define:",
      "<div class=\"centered\"><table class=\"alignedmath\"><tbody><tr><td class=\"lefttight\">0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">=</span>1&nbsp;&nbsp;Def.</td></tr><tr><td class=\"lefttight\">0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">=</span>2&nbsp;&nbsp;Def.</td></tr><tr><td class=\"lefttight\">0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">=</span>3&nbsp;&nbsp;Def.</td></tr><tr><td class=\"lefttight\">and so on.</td></tr></tbody></table></div>"
    ],
    "pearsmcguinness": [
      "And <em>this</em> is how we arrive at numbers. I give the following definitions",
      "<div class=\"centered\"><table class=\"alignedmath\"><tbody><tr><td class=\"righttight\"><var>x</var><span class=\"mathrel\">=</span></td><td class=\"lefttight\"><span class=\"mathop\">Ω<sup>0</sup>’</span><var>x</var>&nbsp;&nbsp;Def.,</td></tr><tr><td class=\"righttight\"><span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω<sup><var>ν</var></sup>’</span><var>x</var><span class=\"mathrel\">=</span></td><td class=\"lefttight\"><span class=\"mathop\">Ω<sup><var>ν</var>+1</sup>’</span><var>x</var>&nbsp;&nbsp;Def.</td></tr></tbody></table></div>",
      "So, in accordance with these rules, which deal with signs, we write the series",
      "<div class=\"displaymath\"><var>x</var>,  <span class=\"mathop\">Ω’</span><var>x</var>,  <span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><var>x</var>,  <span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><var>x</var>,<span class=\"mathrel\">…</span></div>",
      "in the following way",
      "<div class=\"displaymath\"><span class=\"mathop\">Ω<sup>0</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup>0+1</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup>0+1+1</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup>0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1</sup>’</span><var>x</var>,<span class=\"mathrel\">…</span></div>",
      "Therefore, instead of ‘[<var>x</var>,  <var class=\"pushvar\">ξ</var>,  <span class=\"mathop\">Ω’</span><var class=\"pushvar\">ξ</var>]’,",
      "<div class=\"displaymath\">I write&nbsp;&nbsp;‘[<span class=\"mathop\">Ω<sup>0</sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup><var>ν</var></sup>’</span><var>x</var>,  <span class=\"mathop\">Ω<sup><var>ν</var><span class=\"mathrel\">+</span>1</sup>’</span><var>x</var>]’.</div>",
      "And I give the following definitions",
      "<div class=\"centered\"><table class=\"alignedmath\"><tbody><tr><td class=\"righttight\">0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">=</span></td><td class=\"lefttight\">1&nbsp;&nbsp;Def.,</td></tr><tr><td class=\"righttight\">0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">=</span></td><td class=\"lefttight\">2&nbsp;&nbsp;Def.,</td></tr><tr><td class=\"righttight\">0<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">=</span></td><td class=\"lefttight\">3&nbsp;&nbsp;Def.,</td></tr><tr><td class=\"centertight\" colspan=\"2\">(and so on).</td></tr></tbody></table></div>"
    ]
  },
  {
    "number": "6.021",
  ...
  },
  {
    "number": "6.03",
    "german": [
      "Die allgemeine Form der ganzen Zahl ist: [0, <var class=\"pushvar\">ξ</var>, <var>ξ</var><span class=\"mathrel\">+</span>1]."
    ],
    "ogden": [
      "The general form of the cardinal number is: [0, <var class=\"pushvar\">ξ</var>, <var>ξ</var><span class=\"mathrel\">+</span>1]."
    ],
    "pearsmcguinness": [
      "The general form of an integer is [0, <var class=\"pushvar\">ξ</var>, <var>ξ</var><span class=\"mathrel\">+</span>1]."
    ]
  },
  {
    "number": "6.031",
  ...
  },
  {
    ...
    "german": [
      ...
      "<div class=\"centered\"><object data=\"images/abfiguretwogerman.svg\" type=\"image/svg+xml\" width=\"158\" height=\"124\" style=\"width: 158pt; height: 124pt;\"><img src=\"images/abfiguretwogerman.png\" alt=\"[TF figure]\"></object></div>",
      "Dies Zeichen würde also z.&nbsp;B. den Satz <var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var> darstellen. Nun will ich z.&nbsp;B. den Satz <span class=\"mathop\">~</span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>) (Gesetz des Widerspruchs) daraufhin untersuchen, ob er eine Tautologie ist. Die Form „<span class=\"mathop\">~</span><var class=\"pushvar\">ξ</var>“ wird in unserer Notation",
      "<div class=\"centered\"><object data=\"images/abfigurethreegerman.svg\" type=\"image/svg+xml\" width=\"49\" height=\"75\" style=\"width: 49pt; height: 75pt;\"><img src=\"images/abfigurethreegerman.png\" alt=\"[TF figure]\"></object></div>",
      "geschrieben; die Form „<var>ξ</var><span class=\"mathrel\">.</span><var>η</var>“ so:",
      "<div class=\"centered\"><object data=\"images/abfigurefourgerman.svg\" type=\"image/svg+xml\" width=\"158\" height=\"116\" style=\"width: 158pt; height: 116pt;\"><img src=\"images/abfigurefourgerman.png\" alt=\"[TF figure]\"></object></div>",
      "Daher lautet der Satz <span class=\"mathop\">~</span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var>) so:",
      "<div class=\"centered\"><object data=\"images/abfigurefivegerman.svg\" type=\"image/svg+xml\" width=\"133\" height=\"168\" style=\"width: 133pt; height: 168pt;\"><img src=\"images/abfigurefivegerman.png\" alt=\"[TF figure]\"></object></div>",
      "Setzen wir statt „<var>q</var>“ „<var>p</var>“ ein und untersuchen die Verbindung der äußersten W und F mit den innersten, so ergibt sich, dass die Wahrheit des ganzen Satzes <em class=\"germph\">allen</em> Wahrheitskombinationen seines Argumentes, seine Falschheit keiner der Wahrheitskombinationen zugeordnet ist."
    ],
    "ogden": [
      "In order to recognize a tautology as such, we can, in cases in which no sign of generality occurs in the tautology, make use of the following intuitive method: I write instead of “<var>p</var>”, “<var>q</var>”, “<var>r</var>”, etc., “<span class=\"mathrm\">T</span><var class=\"doublepushvar\">p</var><span class=\"mathrm\">F</span>”, “<span class=\"mathrm\">T</span><var class=\"doublepushvar\">q</var><span class=\"mathrm\">F</span>”, “<span class=\"mathrm\">T</span><var class=\"doublepushvar\">r</var><span class=\"mathrm\">F</span>”, etc. The truth-combinations I express by brackets, <em>e.g.</em>:",
      "<div class=\"centered\"><object data=\"images/abfigureoneenglish.svg\" type=\"image/svg+xml\" width=\"156\" height=\"69\" style=\"width: 156pt; height: 69pt;\"><img src=\"images/abfigureoneenglish.png\" alt=\"[TF figure]\"></object></div>",
      ...
      "<div class=\"centered\"><object data=\"images/abfiguretwoenglish.svg\" type=\"image/svg+xml\" width=\"156\" height=\"124\" style=\"width: 156pt; height: 124pt;\"><img src=\"images/abfiguretwoenglish.png\" alt=\"[TF figure]\"></object></div>",
      "This sign, for example, would therefore present the proposition <var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var>. Now I will proceed to inquire whether such a proposition as <span class=\"mathop\">~</span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>) (The Law of Contradiction) is a tautology. The form “<span class=\"mathop\">~</span><var class=\"pushvar\">ξ</var>” is written in our notation",
      "<div class=\"centered\"><object data=\"images/abfigurethreeenglish.svg\" type=\"image/svg+xml\" width=\"47\" height=\"75\" style=\"width: 47pt; height: 75pt;\"><img src=\"images/abfigurethreeenglish.png\" alt=\"[TF figure]\"></object></div>",
      "the form “<var>ξ</var><span class=\"mathrel\">.</span><var>η</var>” thus:—",
      "<div class=\"centered\"><object data=\"images/abfigurefourenglish.svg\" type=\"image/svg+xml\" width=\"156\" height=\"116\" style=\"width: 156pt; height: 116pt;\"><img src=\"images/abfigurefourenglish.png\" alt=\"[TF figure]\"></object></div>",
      "Hence the proposition <span class=\"mathop\">~</span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var>) runs thus:—",
      "<div class=\"centered\"><object data=\"images/abfigurefiveenglish.svg\" type=\"image/svg+xml\" width=\"129\" height=\"168\" style=\"width: 129pt; height: 168pt;\"><img src=\"images/abfigurefiveenglish.png\" alt=\"[TF figure]\"></object></div>",
      "If here we put “<var>p</var>” instead of “<var>q</var>” and examine the combination of the outermost T and F with the innermost, it is seen that the truth of the whole proposition is co-ordinated with <em>all</em> the truth-combinations of its argument, its falsity with none of the truth-combinations."
    ],
    "pearsmcguinness": [
      "In order to recognize an expression as a tautology, in cases where no generality-sign occurs in it, one can employ the following intuitive method: instead of ‘<var>p</var>’, ‘<var>q</var>’, ‘<var>r</var>’, etc. I write ‘<span class=\"mathrm\">T</span><var class=\"doublepushvar\">p</var><span class=\"mathrm\">F</span>’, ‘<span class=\"mathrm\">T</span><var class=\"doublepushvar\">q</var><span class=\"mathrm\">F</span>’, ‘<span class=\"mathrm\">T</span><var class=\"doublepushvar\">r</var><span class=\"mathrm\">F</span>’, etc. Truth-combinations I express by means of brackets, e.g.",
      "<div class=\"centered\"><object data=\"images/abfigureoneenglishpmc.svg\" type=\"image/svg+xml\" width=\"157\" height=\"69\" style=\"width: 157pt; height: 69pt;\"><img src=\"images/abfigureoneenglishpmc.png\" alt=\"[TF figure]\"></object></div>",
      ...
      "<div class=\"centered\"><object data=\"images/abfiguretwoenglishpmc.svg\" type=\"image/svg+xml\" width=\"157\" height=\"124\" style=\"width: 157pt; height: 124pt;\"><img src=\"images/abfiguretwoenglishpmc.png\" alt=\"[TF figure]\"></object></div>",
      "So this sign, for instance, would represent the proposition <var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var>. Now, by way of example, I wish to examine the proposition <span class=\"mathop\">~</span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>p</var>) (the law of contradiction) in order to determine whether it is a tautology. In our notation the form ‘<span class=\"mathop\">~</span><var class=\"pushvar\">ξ</var>’ is written as",
      "<div class=\"centered\"><object data=\"images/abfigurethreeenglishpmc.svg\" type=\"image/svg+xml\" width=\"46\" height=\"75\" style=\"width: 46pt; height: 75pt;\"><img src=\"images/abfigurethreeenglishpmc.png\" alt=\"[TF figure]\"></object></div>",
      "and the form ‘<var>ξ</var><span class=\"mathrel\">.</span><var>η</var>’ as",
      "<div class=\"centered\"><object data=\"images/abfigurefourenglishpmc.svg\" type=\"image/svg+xml\" width=\"157\" height=\"116\" style=\"width: 157pt; height: 116pt;\"><img src=\"images/abfigurefourenglishpmc.png\" alt=\"[TF figure]\"></object></div>",
      "Hence the proposition <span class=\"mathop\">~</span>(<var>p</var><span class=\"mathrel\">.</span><span class=\"mathop\">~</span><var>q</var>) reads as follows",
      "<div class=\"centered\"><object data=\"images/abfigurefiveenglishpmc.svg\" type=\"image/svg+xml\" width=\"129\" height=\"168\" style=\"width: 129pt; height: 168pt;\"><img src=\"images/abfigurefiveenglishpmc.png\" alt=\"[TF figure]\"></object></div>",
      "If we here substitute ‘<var>p</var>’ for ‘<var>q</var>’ and examine how the outermost T and F are connected with the innermost ones, the result will be that the truth of the whole proposition is correlated with <em>all</em> the truth-combinations of its argument, and its falsity with none of the truth-combinations."
    ]
  },
  {
    "number": "6.121",
  ...
  },
  {
    "number": "6.1221",
    "german": [
      "Ergeben z.&nbsp;B. zwei Sätze „<var>p</var>“ und „<var>q</var>“ in der Verbindung „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var>“ eine Tautologie, so ist klar, dass <var>q</var> aus <var>p</var> folgt.",
      "Dass z.&nbsp;B. „<var>q</var>“ aus „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var><span class=\"mathrel\">.</span><var>p</var>“ folgt, ersehen wir aus diesen beiden Sätzen selbst, aber wir können es auch <em class=\"germph\">so</em> zeigen, indem wir sie zu „<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var><span class=\"mathrel\">.</span><var>p</var><span class=\"mathrel\">:<span class=\"symbol\">⊃</span>:</span><var>q</var>“ verbinden und nun zeigen, dass dies eine Tautologie ist."
    ],
    "ogden": [
      "If for example two propositions “<var>p</var>” and “<var>q</var>” give a tautology in the connexion “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var>”, then it is clear that <var>q</var> follows from <var>p</var>.",
      "<em>E.g.</em> that “<var>q</var>” follows from “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var><span class=\"mathrel\">.</span><var>p</var>” we see from these two propositions themselves, but we can also show it by combining them to “<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var><span class=\"mathrel\">.</span><var>p</var><span class=\"mathrel\">:<span class=\"symbol\">⊃</span>:</span><var>q</var>” and then showing that this is a tautology."
    ],
    "pearsmcguinness": [
      "If, for example, two propositions ‘<var>p</var>’ and ‘<var>q</var>’ in the combination ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var>’ yield a tautology, then it is clear that <var>q</var> follows from <var>p</var>.",
      "For example, we see from the two propositions themselves that ‘<var>q</var>’ follows from ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var><span class=\"mathrel\">.</span><var>p</var>’, but it is also possible to show it in <em>this</em> way: we combine them to form ‘<var>p</var><span class=\"mathrel\"><span class=\"symbol\">⊃</span></span><var>q</var><span class=\"mathrel\">.</span><var>p</var><span class=\"mathrel\">:<span class=\"symbol\">⊃</span>:</span><var>q</var>’, and then show that this is a tautology."
    ]
  },
  {
    "number": "6.1222",
  ...
  },
  {
    ...
    "german": [
      ...
      "Es ist eine Eigenschaft von „1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1“, dass man es als „(1<span class=\"mathrel\">+</span>1)<span class=\"mathrel\">+</span>(1<span class=\"mathrel\">+</span>1)“ auffassen kann."
    ],
    "ogden": [
      "It is a property of affirmation that it can be conceived as double denial.",
      "It is a property of “1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1” that it can be conceived as “(1<span class=\"mathrel\">+</span>1)<span class=\"mathrel\">+</span>(1<span class=\"mathrel\">+</span>1)”."
    ],
    "pearsmcguinness": [
      "It is a property of affirmation that it can be construed as double negation.",
      "It is a property of ‘1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1’ that it can be construed as ‘(1<span class=\"mathrel\">+</span>1)<span class=\"mathrel\">+</span>(1<span class=\"mathrel\">+</span>1)’."
    ]
  },
  {
    "number": "6.232",
  ...
  },
  {
    "number": "6.241",
    "german": [
      "So lautet der Beweis des Satzes 2<span class=\"mathrel\">×</span>2<span class=\"mathrel\">=</span>4:",
    ...
    "ogden": [
      "Thus the proof of the proposition 2<span class=\"mathrel\">×</span>2<span class=\"mathrel\">=</span>4 runs:",
      "<div class=\"centered\">\n<span class=\"mathop\">(Ω<sup><var>ν</var></sup>)<sup><var>μ</var></sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">Ω<sup><var>ν</var><span class=\"mathrel\">×</span><var>μ</var></sup>’</span><var>x</var> Def.<br>\n\n<span class=\"mathop\">Ω<sup>2<span class=\"mathrel\">×</span>2</sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">(Ω<sup>2</sup>)<sup>2</sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">(Ω<sup>2</sup>)<sup>1<span class=\"mathrel\">+</span>1</sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">Ω<sup>2</sup>’</span><span class=\"mathop\">Ω<sup>2</sup>’</span><var>x</var><br>\n\n = <span class=\"mathop\">Ω<sup>1<span class=\"mathrel\">+</span>1</sup>’</span><span class=\"mathop\">Ω<sup>1<span class=\"mathrel\">+</span>1</sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">(Ω’Ω)’</span><span class=\"mathop\">(Ω’Ω)’</span><var>x</var><br>\n\n= <span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">Ω<sup>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1</sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">Ω<sup>4</sup>’</span><var>x</var>.<br>\n\n</div>"
    ],
    "pearsmcguinness": [
      "Thus the proof of the proposition 2<span class=\"mathrel\">×</span>2<span class=\"mathrel\">=</span>4 runs as follows:",
      "<div class=\"centered\">\n<span class=\"mathop\">(Ω<sup><var>ν</var></sup>)<sup><var>μ</var></sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">Ω<sup><var>ν</var><span class=\"mathrel\">×</span><var>μ</var></sup>’</span><var>x</var> Def.<br>\n\n<span class=\"mathop\">Ω<sup>2<span class=\"mathrel\">×</span>2</sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">(Ω<sup>2</sup>)<sup>2</sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">(Ω<sup>2</sup>)<sup>1<span class=\"mathrel\">+</span>1</sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">Ω<sup>2</sup>’</span><span class=\"mathop\">Ω<sup>2</sup>’</span><var>x</var><br>\n\n = <span class=\"mathop\">Ω<sup>1<span class=\"mathrel\">+</span>1</sup>’</span><span class=\"mathop\">Ω<sup>1<span class=\"mathrel\">+</span>1</sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">(Ω’Ω)’</span><span class=\"mathop\">(Ω’Ω)’</span><var>x</var><br>\n= <span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><span class=\"mathop\">Ω’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">Ω<sup>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1<span class=\"mathrel\">+</span>1</sup>’</span><var>x</var><span class=\"mathrel\">=</span><span class=\"mathop\">Ω<sup>4</sup>’</span><var>x</var>.<br>\n\n</div>"
    ]
  },
  {
  ...
  },
  {
    ...
    "ogden": [
      "The law of causality is not a law but the form of a law.<a href=\"#fn2\" id=\"fn2marker\">†</a>"
    ],
    "pearsmcguinness": [
  ...
  },
  {
    "number": "6.36111",
    "german": [
      "Das Kant’sche Problem von der rechten und linken Hand, die man nicht zur Deckung bringen kann, besteht schon in der Ebene, ja im eindimensionalen Raum, wo die beiden kongruenten Figuren <var>a</var> und <var>b</var> auch nicht zur Deckung gebracht werden können, ohne aus diesem Raum",
      "<div class=\"centeredsqueeze\"><b>–&nbsp;–&nbsp;–&nbsp;<span class=\"tight\"><span class=\"symbol\">○</span>————<span class=\"nudgedown\"><span class=\"symbol\">✕</span></span></span>&nbsp;–&nbsp;–&nbsp;<span class=\"tight\"><span class=\"nudgedown\"><span class=\"symbol\">✕</span></span>————<span class=\"symbol\">○</span></span>&nbsp;–&nbsp;–&nbsp;–</b><br><var class=\"smallvar\">a</var>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<var class=\"smallvar\">b</var></div>",
    ...
    "ogden": [
      "The Kantian problem of the right and left hand which cannot be made to cover one another already exists in the plane, and even in one-dimensional space; where the two congruent figures <var>a</var> and <var>b</var> cannot be made to cover one another without ",
      "<div class=\"centeredsqueeze\"><b>–&nbsp;–&nbsp;–&nbsp;<span class=\"tight\"><span class=\"symbol\">○</span>————<span class=\"nudgedown\"><span class=\"symbol\">✕</span></span></span>&nbsp;–&nbsp;–&nbsp;<span class=\"tight\"><span class=\"nudgedown\"><span class=\"symbol\">✕</span></span>————<span class=\"symbol\">○</span></span>&nbsp;–&nbsp;–&nbsp;–</b><br><var class=\"smallvar\">a</var>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<var class=\"smallvar\">b</var></div>",
    ...
    "pearsmcguinness": [
      ...
      "<div class=\"centeredsqueeze\"><b>–&nbsp;–&nbsp;–&nbsp;<span class=\"tight\"><span class=\"symbol\">○</span>————<span class=\"nudgedown\"><span class=\"symbol\">✕</span></span></span>&nbsp;–&nbsp;–&nbsp;<span class=\"tight\"><span class=\"nudgedown\"><span class=\"symbol\">✕</span></span>————<span class=\"symbol\">○</span></span>&nbsp;–&nbsp;–&nbsp;–</b><br><var class=\"smallvar\">a</var>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<var class=\"smallvar\">b</var></div>",
      "in which the two congruent figures, <var>a</var> and <var>b</var>, cannot be made to coincide unless they are moved out of this space. The right hand and the left hand are in fact completely congruent. It is quite irrelevant that they cannot be made to coincide. ",
