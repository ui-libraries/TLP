    ...
    displayText(showSelector, version, divCounter, template, util) {
        ...
        let element = $(
            '<div class="panel panel-default">' +
                ...
                this.label +
                '<span class="glyphicon glyphicon-remove close-panel" style="float:right"></span></a>' +
                "</h4>" +
                "</div>" +
                '<div id="' +
                div +
                '" class="panel-collapse collapse in"><div class="panel-body" value="' +
                this.label +
                '"></div>'
        ).appendTo("#accordion")
        ...
        if (showSelector) {
            ...
            let langVersion =
                template == "pt" ? "pt-lang-version.html" : "lang-version.html"
        ...
        $("#" + div + " .panel-body").attr(
            "ger",
            this.getTextForSelectedVersion("ger")
        )
        $("#" + div + " .panel-body").attr(
            "ogd",
            this.getTextForSelectedVersion("ogd")
        )
        $("#" + div + " .panel-body").attr(
            "pmc",
            this.getTextForSelectedVersion("pmc")
        )
        $("#" + div + " .panel-body").attr(
            "str",
